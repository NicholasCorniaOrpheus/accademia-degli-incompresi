# Piangete meco, afflitti occhi dolenti (DbxBgjNTJHqz)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/DbxBgjNTJHqz.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/DbxBgjNTJHqz.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/DbxBgjNTJHqz.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/piangete_meco,_afflitti_occhi_dolenti){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Piangete meco, afflitti occhi dolenti
    - id: DbxBgjNTJHqz
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/DbxBgjNTJHqz.json";
    </script>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/piangete_meco,_afflitti_occhi_dolenti/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
