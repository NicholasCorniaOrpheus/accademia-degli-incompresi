# Primo libro de Madrigali a quatro voci di l'Hoste da Reggio (7PPRiYwEybka)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/7PPRiYwEybka.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/7PPRiYwEybka.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/7PPRiYwEybka.csv){ .md-button }
...
!!! note "metadata"
    - class: NotatedMusic
    - label: Primo libro de Madrigali a quatro voci di l'Hoste da Reggio
    - id: 7PPRiYwEybka
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/7PPRiYwEybka.json";
    </script>
...
???+ abstract "title"
    - Primo libro de madrigali a quatro voci di l'Hoste da Regio

???+ abstract "has version"
    - 
        * external source: [T251](http://www.bibliotecamusica.it/cmbm/viewschedatwbca.asp?path=/cmbm/images/ripro/gaspari/_T/T251/)
        ...
        * permalink: [CNCE044052](https://edit16.iccu.sbn.it/titolo/CNCE044052)
    - 
        * permalink: [CNCE044059](https://edit16.iccu.sbn.it/titolo/CNCE044059)
        * external source: [T250](http://www.bibliotecamusica.it/cmbm/viewschedatwbca.asp?path=/cmbm/images/ripro/gaspari/_T/T250/)
        * place of publication: [Venezia](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/TKTukTBozhcq)
        * publication date: 1547
        * publisher: [Antonio Gardano](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/btogkstkNfhe)
        * note: Canto part only
