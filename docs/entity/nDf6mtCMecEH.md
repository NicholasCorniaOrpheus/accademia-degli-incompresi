# Heraklion (nDf6mtCMecEH)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/nDf6mtCMecEH.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/nDf6mtCMecEH.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/nDf6mtCMecEH.csv){ .md-button }
...
!!! note "metadata"
    - class: Place
    - label: Heraklion
    - description: city in the island of Crete
    - aliases: Candia
    - id: nDf6mtCMecEH
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/nDf6mtCMecEH.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q160544](http://www.wikidata.org/entity/Q160544)
