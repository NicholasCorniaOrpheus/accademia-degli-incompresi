# Penetra con l'acuto alto intelletto (WnVGb9bw8sGo)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/WnVGb9bw8sGo.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/WnVGb9bw8sGo.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/WnVGb9bw8sGo.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/penetra_con_l'acuto_alto_intelletto){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Penetra con l'acuto alto intelletto
    - id: WnVGb9bw8sGo
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/WnVGb9bw8sGo.json";
    </script>
...
???+ abstract "part of"
    - [La Scanderbeide poema heroico della signora Margherita Sarrocchi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/AmmUd8Ddd3Qw)
        * section: Canto III, 38
        * pages: 23

???+ abstract "subject"
    - [astrology](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/TkUXmQEgY6Yz)
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/penetra_con_l'acuto_alto_intelletto/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
