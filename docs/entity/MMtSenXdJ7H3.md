# Se quando per Adone, over per Marte (MMtSenXdJ7H3)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/MMtSenXdJ7H3.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/MMtSenXdJ7H3.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/MMtSenXdJ7H3.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/occhi_lucenti,_e_belli){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Se quando per Adone, over per Marte
    - description: Poem dedicated to her husband, count Gilberto VII da Correggio.
    - id: MMtSenXdJ7H3
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/MMtSenXdJ7H3.json";
    </script>
...
???+ abstract "depicts"
    - [condottiero](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/nTQUTXBcAmeX)
    - [Adonis](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ghcPKASj753i)
    - [Mars](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/gSKYwN6xYzZN)

???+ abstract "text"
    - Se quando per Adone, over per Marte<br>
      Arse Venere bella,<br>
      Stato fossi Signor visto da lei,<br>
      Quell'ardente facella<br>
      Sol per te, che di lor più degno sei,<br>
      Arsa, e accesa l'havrebbe in ogni parte;<br>
      <br>
      Perché ne l'armi il bellicoso Marte<br>
      Vinci d’assai; e di bellezza Adone<br>
      Cede al tuo paragone.<br>
      Dunque se 'l Ciel t'aspira, e fa immortale,<br>
      Meraviglia non è, poiché sei tale.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/occhi_lucenti,_e_belli/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
