# (Cosentino 2017) (CP9zVMgo5ssa)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/CP9zVMgo5ssa.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/CP9zVMgo5ssa.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/CP9zVMgo5ssa.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Cosentino 2017)
    - aliases: cosentinoArtistiAutoriAttori2017
    - id: CP9zVMgo5ssa
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/CP9zVMgo5ssa.json";
    </script>
...
???+ abstract "citation"
    - Cosentino, Paola. 2017. ‘Artisti, autori, attori. Su alcune accademie seicentesche a Firenze’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 51–64. Roma: De Luca editori d’arte.
