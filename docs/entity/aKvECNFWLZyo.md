# Quando sarà ch'io mora (aKvECNFWLZyo)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/aKvECNFWLZyo.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/aKvECNFWLZyo.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/aKvECNFWLZyo.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Quando sarà ch'io mora
    - description: The poem describes the division of the soul in separation as it seeks to maintain union with the absent beloved
    - id: aKvECNFWLZyo
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/aKvECNFWLZyo.json";
    </script>
...
???+ abstract "part of"
    - [(Gambara 1995)](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/oGnKtr52k4Ac)
        * section: 3
        * pages: 59
...
???+ abstract "text"
    - Quando sarà ch'io mora,<br>
      Amor, se ’n questa cruda dipartita<br>
      Non può tanto dolor finir mia vita?<br>
      <br>
      Qualor avien ch'io pensi<br>
      Quel che dir mi volea l’ultimo sguardo<br>
      E'l partir lento e tardo,<br>
      con quei sospir sì accensi,<br>
      come pon star in me l’anima e i sensi?<br>
      <br>
      S'allor ch'io gli odii dire<br>
      Quell'ultime parole in tanto ardore<br>
      Non mi s’aperse il core,<br>
      E non potei morire,<br>
      Quando potrò mai più di vita uscire?<br>
      <br>
      Io n'uscirò, ch'a tant'aspro martire<br>
      Non potrò già durar, vedermi priva<br>
