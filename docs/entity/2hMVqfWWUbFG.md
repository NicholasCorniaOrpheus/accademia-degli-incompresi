# Se poteste Signor con l'occhio interno (2hMVqfWWUbFG)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/2hMVqfWWUbFG.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/2hMVqfWWUbFG.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/2hMVqfWWUbFG.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/accademia-degli-incompresi/assets/poems/se_poteste_signor_con_l'occhio_interno){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Se poteste Signor con l'occhio interno
    - id: 2hMVqfWWUbFG
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/2hMVqfWWUbFG.json";
    </script>
...
???+ abstract "depicts"
    ...
    - [abyss](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/gTFK5xEZrb79)
    - [jealousy](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/H8pNPRSuos4Q)

???+ abstract "language"
    - [Italian](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/85kGqMwffVs7)

???+ abstract "text"
    - Se poteste Signor con l'occhio interno<br>
      Penetrar'i segreti del mio core,<br>
      Come vedete queste ombre di fuore,<br>
      Apertamente con questo occhio esterno,<br>
      <br>
      Vi vedreste le pene de l'Inferno,<br>
      Un abisso infinito di dolore,<br>
      Quanta mai gelosia, quanto timore<br>
      Amor'ha dato, o può dar'in eterno.<br>
      <br>
      E vedreste voi stesso seder donno<br>
      In mezo a l'alma, cui tanti tormenti<br>
      Non han potuto mai cavarvi, o ponno.<br>
      <br>
      E tutti altri disir vedreste spenti,<br>
      Od oppressi da grave et alto sonno,<br>
      E sol quei d'haver voi, desti & ardenti.
...
window.kbGraphConfig.assets = {
  ...
  local_path: "assets/poems/se_poteste_signor_con_l'occhio_interno/",
  images: ["001.jpg"],
  iiif: []
};
</script>
