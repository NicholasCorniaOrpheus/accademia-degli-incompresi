# Colma di fasto, io me ne già cantando (Zdv7qQYJNmNt)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/Zdv7qQYJNmNt.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/Zdv7qQYJNmNt.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/Zdv7qQYJNmNt.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/colma_di_fasto,_io_me_ne_gia_cantando){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Colma di fasto, io me ne già cantando
    - id: Zdv7qQYJNmNt
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/Zdv7qQYJNmNt.json";
    </script>
...
???+ abstract "subject"
    ...
    - [mortality](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/BCzTXjHPZh72)
...
???+ abstract "depicts"
    - [flower](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/jwx5X37nmtsV)
...
???+ abstract "text"
    - Colma di fasto, io me ne già cantando<br>
      Lungo un fiorito colle;<br>
      E quasi (oh mia sciochezza,)<br>
      Godea di questa mia frale bellezza;<br>
      Quando frai l'herba molle<br>
      Vidi languir un fiore<br>
      Privo del suo vital soav'humore.<br>
      E conobbi, che tale<br>
      Era beltà mortale.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/colma_di_fasto,_io_me_ne_gia_cantando/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
