# (Hendrix 2017) (Ev3YuNAVyPXa)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/Ev3YuNAVyPXa.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/Ev3YuNAVyPXa.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/Ev3YuNAVyPXa.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Hendrix 2017)
    - aliases: hendrixSodalizioRomanoBentveughels2017
    - id: Ev3YuNAVyPXa
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/Ev3YuNAVyPXa.json";
    </script>
...
???+ abstract "citation"
    - Hendrix, Harald. 2017. ‘Il sodalizio romano dei Bentveughels e la tradizione accademica tra Italia e Paesi Bassi’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Paolo Procaccioli, 241–53. Roma: De Luca editori d’arte.
