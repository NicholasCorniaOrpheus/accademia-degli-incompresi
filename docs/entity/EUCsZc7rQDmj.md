# Filli. Dimmi, lasso, mio core (EUCsZc7rQDmj)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/EUCsZc7rQDmj.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/EUCsZc7rQDmj.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/EUCsZc7rQDmj.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/filli._dimmi,_lasso,_mio_core){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Filli. Dimmi, lasso, mio core
    - id: EUCsZc7rQDmj
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/EUCsZc7rQDmj.json";
    </script>
...
???+ abstract "part of"
    - [Rime di diversi celebri poeti dell'età nostra](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dUxL6iZT2qYu)
        * section: Rime della S. Isabella Andreini.
        * pages: 287

???+ abstract "subject"
    - [dialogue](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/2UUH2dSJC9jn)
...
???+ abstract "depicts"
    - [death](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/D3F7Qwb9dCYu)
    - [heart](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/EbB4YoFvmYce)
    - [Filli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/KK8VRgevLrxL)

???+ abstract "language"
    - [Italian](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/85kGqMwffVs7)

???+ abstract "text"
    - Filli. DIMMI, lasso, mio core,<br>
      Quand'havrà fine il mio sì lungo errore?<br>
      Core. Incauta, hor come vuoi<br>
      Ch'habbiano fine i miei martiri, e i tuoi,<br>
      Se di me ti privasti,<br>
      Et a chi non mi volse, m'inviasti?<br>
      Ei non mi vuol; tu mi ricusi: ond'io<br>
      Odio lo stato mio.<br>
      Filli. Dunque non havrà fin sì dura sorte?<br>
      Core. Non havrà fin giamai, se non per morte.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/filli._dimmi,_lasso,_mio_core/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
