# Margherita Sarrocchi (jUkaVk3KRX7R)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/jUkaVk3KRX7R.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/jUkaVk3KRX7R.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/jUkaVk3KRX7R.csv){ .md-button }


<img src="https://upload.wikimedia.org/wikipedia/commons/3/33/Margherita_Sarrocchi.jpg?utm_source=www.wikidata.org&utm_campaign=imageinfo&utm_content=original" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Agent
    - label: Margherita Sarrocchi
    - aliases: Margherita Sarocchi
    - id: jUkaVk3KRX7R
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/jUkaVk3KRX7R.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q3846961](http://www.wikidata.org/entity/Q3846961)

???+ abstract "described by source"
    - [Italian Women Writers](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/fGNbusFoz4E3)
