# Fiori di sacra poesia dell'Irresoluto Accademico Intronato (VtZtvHisdWzn)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/VtZtvHisdWzn.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/VtZtvHisdWzn.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/VtZtvHisdWzn.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Fiori di sacra poesia dell'Irresoluto Accademico Intronato
    - id: VtZtvHisdWzn
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/VtZtvHisdWzn.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [TO0E007828](http://id.sbn.it/bid/TO0E007828)

???+ abstract "instance of"
    - [poetry collection](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/QzqW58VYGKNm)

???+ abstract "title"
    - Fiori di sacra poesia dell'Irresoluto Accademico Intronato. Raccolti da Gio. Francesco Polelli

???+ abstract "has version"
    - 
        * publisher: [Libraria della Luna](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/HxqB952bqvFP)
        * publication date: 1625
        * permalink: [TO0E007828](http://id.sbn.it/bid/TO0E007828)
        * place of publication: [Roma](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/goQpBvjkzHLx)
        * external source: [P0B3fRdTBQEC](https://books.google.be/books?id=P0B3fRdTBQEC)
...
???+ abstract "has part"
    - [Sciogli la lingua al canto, e leghi i cori](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/KTNy58Y2k59j)
