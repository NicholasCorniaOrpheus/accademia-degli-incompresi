# Public Library Leipzig (7Szxsh2Xinkm)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/7Szxsh2Xinkm.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/7Szxsh2Xinkm.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/7Szxsh2Xinkm.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Public Library Leipzig
    - aliases: Leipziger Stadtbibliothek
    - id: 7Szxsh2Xinkm
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/7Szxsh2Xinkm.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q2326875](http://www.wikidata.org/entity/Q2326875)
...
???+ abstract "official website"
    - [sachsen.digital](https://sachsen.digital/)
