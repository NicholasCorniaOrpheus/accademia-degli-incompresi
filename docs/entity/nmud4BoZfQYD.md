# (Terzaghi 2017) (nmud4BoZfQYD)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/nmud4BoZfQYD.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/nmud4BoZfQYD.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/nmud4BoZfQYD.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Terzaghi 2017)
    - citation: Terzaghi, Maria Cristina. 2017. ‘L’accademico Ottavio Tronsarelli e il suo contributo alle Vite di Giovanni Baglione’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Paolo Procaccioli, 195–211. Roma: De Luca editori d’arte.
    - id: nmud4BoZfQYD
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/nmud4BoZfQYD.json";
    </script>
