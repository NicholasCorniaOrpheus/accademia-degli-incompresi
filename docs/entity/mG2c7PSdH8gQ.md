# Rime della Accademia de gli Accesi di Palermo (mG2c7PSdH8gQ)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/mG2c7PSdH8gQ.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/mG2c7PSdH8gQ.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/mG2c7PSdH8gQ.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Rime della Accademia de gli Accesi di Palermo
    - id: mG2c7PSdH8gQ
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/mG2c7PSdH8gQ.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE000024](https://edit16.iccu.sbn.it/titolo/CNCE000024)

???+ abstract "instance of"
    - [poetry collection](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/XzeQyQXbyjmR)

???+ abstract "title"
    - Rime della Accademia de gli Accesi di Palermo

???+ abstract "has version"
    - 
        * publication date: 1571
        * permalink: [CNCE000024](https://edit16.iccu.sbn.it/titolo/CNCE000024)
        * place of publication: [Palermo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ReXg6kyDseAt)
        * external source: [BKe0YP2sGZUC](https://books.google.it/books?id=BKe0YP2sGZUC)
