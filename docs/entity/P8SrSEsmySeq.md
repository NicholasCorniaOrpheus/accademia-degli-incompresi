# Della nova scelta di rime di diversi eccellenti scrittori de l'età nostra parte prima (P8SrSEsmySeq)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/P8SrSEsmySeq.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/P8SrSEsmySeq.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/P8SrSEsmySeq.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Della nova scelta di rime di diversi eccellenti scrittori de l'età nostra parte prima
    - id: P8SrSEsmySeq
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/P8SrSEsmySeq.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE036264](https://edit16.iccu.sbn.it/titolo/CNCE036264)

???+ abstract "instance of"
    - [poetry collection](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/XzeQyQXbyjmR)

???+ abstract "title"
    - Della noua scelta di rime di diuersi eccellenti scrittori de l'età nostra parte prima nouamente raccolte et mandate in luce per Benedetto Varoli

???+ abstract "has version"
    - 
        * permalink: [CNCE036264](https://edit16.iccu.sbn.it/titolo/CNCE036264)
        * publication date: 1590

???+ abstract "contributor"
    - [Benedetto Varoli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/eT7HYYCeNwWA)
