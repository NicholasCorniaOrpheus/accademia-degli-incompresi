# (Chiummo, Geremicca, and Tosini 2017) (av4vtP8gSHzR)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/av4vtP8gSHzR.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/av4vtP8gSHzR.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/av4vtP8gSHzR.csv){ .md-button }
...
!!! note "metadata"
    ...
    - citation: Chiummo, Carla, Antonio Geremicca, and Patrizia Tosini, eds. 2017. Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento. Roma: De Luca editori d’arte.
    - id: av4vtP8gSHzR
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/av4vtP8gSHzR.json";
    </script>
