# (Cosentino 2017) (33m7VRuTvPQw)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/33m7VRuTvPQw.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/33m7VRuTvPQw.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/33m7VRuTvPQw.csv){ .md-button }
...
!!! note "metadata"
    ...
    - citation: Cosentino, Paola. 2017. ‘Artisti, autori, attori. Su alcune accademie seicentesche a Firenze’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 51–64. Roma: De Luca editori d’arte.
    - id: 33m7VRuTvPQw
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/33m7VRuTvPQw.json";
    </script>
