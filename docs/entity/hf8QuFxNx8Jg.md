# (Occhipinti 2017) (hf8QuFxNx8Jg)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/hf8QuFxNx8Jg.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/hf8QuFxNx8Jg.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/hf8QuFxNx8Jg.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Occhipinti 2017)
    - aliases: occhipintiSullAccademiaNottiVaticane2017
    - id: hf8QuFxNx8Jg
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/hf8QuFxNx8Jg.json";
    </script>
...
???+ abstract "citation"
    - Occhipinti, Carmelo. 2017. ‘Sull’Accademia delle Notti Vaticane. Scritti di Carlo Borromeo, Giovanni Battista Amalteo e di altri sodali’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Paolo Procaccioli, 125–37. Roma: De Luca editori d’arte.
