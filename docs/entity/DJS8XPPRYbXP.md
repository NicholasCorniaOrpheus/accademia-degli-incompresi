# barzelletta (DJS8XPPRYbXP)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/DJS8XPPRYbXP.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/DJS8XPPRYbXP.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/DJS8XPPRYbXP.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: barzelletta
    - description: Light poetic form using octosyllable verses.
    - aliases: scherzo
    - id: DJS8XPPRYbXP
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/DJS8XPPRYbXP.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q3635495](http://www.wikidata.org/entity/Q3635495)
