# Ruggier, qual sempre fui, tal esser voglio (MrwKLwDFwkkz)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/MrwKLwDFwkkz.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/MrwKLwDFwkkz.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/MrwKLwDFwkkz.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Ruggier, qual sempre fui, tal esser voglio
    - id: MrwKLwDFwkkz
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/MrwKLwDFwkkz.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [31136](https://versologie.cz/poetree/browser/poem?corpus=it&id_poem=31136)
...
???+ abstract "depicts"
    - [Ruggiero](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/JA26R7Tijr8L)
...
???+ abstract "text"
    - Ruggier, qual sempre fui, tal esser voglio<br>
      Fin alla morte, e più, se più si puote.<br>
      O sìami Amor benigno o m'usi orgoglio,<br>
      O me Fortuna in alto o in basso ruote,<br>
      Immobil son di vera fede scoglio<br>
      Che d'ogn'intorno il vento e il mar percuote:<br>
      Né già mai per bonaccia né per verno<br>
