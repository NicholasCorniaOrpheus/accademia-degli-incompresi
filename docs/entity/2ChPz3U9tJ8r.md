...
[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/2ChPz3U9tJ8r.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/2ChPz3U9tJ8r.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/2ChPz3U9tJ8r.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: kiss
    - aliases: bacio; baci; basia; basium
    - id: 2ChPz3U9tJ8r
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/2ChPz3U9tJ8r.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q7307](http://www.wikidata.org/entity/Q7307)
