# Quella che 'n voi bontà quasi infinita (EdSae6LqbqRj)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/EdSae6LqbqRj.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/EdSae6LqbqRj.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/EdSae6LqbqRj.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Quella che 'n voi bontà quasi infinita
    - id: EdSae6LqbqRj
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/EdSae6LqbqRj.json";
    </script>
...
???+ abstract "contributor"
    - [Raffaello da Montelupo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/BvdngmrfmwNS)
...
???+ abstract "depicts"
    - [sculptor](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/TrNJvhKd8rv2)
    - [sculpture](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/iyAxqWyBQcFn)

???+ abstract "text"
    - Quella che 'n voi bontà quasi infinita<br>
      Amai, nel vostro e mio giovanil fiore,<br>
      E quella, non di lei virtù minore,<br>
      Di dare ai bronzi moto, ai i marmi vita,<br>
      Di giorno in giorno in voi col tempo è gita<br>
      Crescendo, sì che quella il primo honore<br>
      Quest' ha il secondo et vi nasce e vi muore<br>
      Il sol vostro valor doppio d'addita.
