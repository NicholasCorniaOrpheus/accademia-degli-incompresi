# (Procaccioli 2017) (kXjL6DtuzHKC)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/kXjL6DtuzHKC.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/kXjL6DtuzHKC.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/kXjL6DtuzHKC.csv){ .md-button }
...
!!! note "metadata"
    ...
    - citation: Procaccioli, Paolo. 2017. ‘Dionigi Atanagi e le accademie della Roma farnesina’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 77–90. Roma: De Luca editori d’arte.
    - id: kXjL6DtuzHKC
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/kXjL6DtuzHKC.json";
    </script>
