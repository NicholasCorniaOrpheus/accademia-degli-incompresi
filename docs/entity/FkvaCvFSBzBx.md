# (Moroncini 2017) (FkvaCvFSBzBx)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/FkvaCvFSBzBx.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/FkvaCvFSBzBx.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/FkvaCvFSBzBx.csv){ .md-button }
...
!!! note "metadata"
    ...
    - citation: Moroncini, Ambra. 2017. ‘Il «Giuoco de la Virtù »: un intreccio accademico tra “Stravaganze” letterarie e suggestioni evangeliche’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 101–10. Roma: De Luca editori d’arte.
    - id: FkvaCvFSBzBx
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/FkvaCvFSBzBx.json";
    </script>
