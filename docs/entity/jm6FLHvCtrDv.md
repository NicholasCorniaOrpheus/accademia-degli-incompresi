# Angelica, se'l mondo (jm6FLHvCtrDv)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/jm6FLHvCtrDv.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/jm6FLHvCtrDv.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/jm6FLHvCtrDv.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/angelica,_se'l_mondo){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Angelica, se'l mondo
    - description: Madrigale in praise of Angelica N., musician.
    - id: jm6FLHvCtrDv
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/jm6FLHvCtrDv.json";
    </script>
...
???+ abstract "part of"
    - [Rime di Ottavio Tronsarelli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/YwBMpr45NG8a)
        * section: Alla Signoraa Angelica N. sonatrice
        * pages: 182
...
???+ abstract "text"
    - Angelica, se'l mondo<br>
      Con occulti tormenti<br>
      E vivo Inferno di pensier nocenti,<br>
      Per te solo il mio petto<br>
      Di contento è ricetto;<br>
      Poiché, con suon giocondo,<br>
      Temprando i pensier miei,<br>
