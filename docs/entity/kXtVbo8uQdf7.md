# (Nicolaci 2017) (kXtVbo8uQdf7)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/kXtVbo8uQdf7.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/kXtVbo8uQdf7.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/kXtVbo8uQdf7.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Nicolaci 2017)
    - aliases: nicolaciGerusalemmeDistruttaDi2017
    - id: kXtVbo8uQdf7
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/kXtVbo8uQdf7.json";
    </script>
...
???+ abstract "citation"
    - Nicolaci, Michele. 2017. ‘La Gerusalemme distrutta di Paolo Giudotti Borghese pittore e poeta lucchese’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 181–93. Roma: De Luca editori d’arte. https://normandie-univ.hal.science/hal-01829101.
