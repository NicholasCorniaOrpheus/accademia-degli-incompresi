# Oh lagrime, ch'ad arte (gyoxuhNh9c7b)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/gyoxuhNh9c7b.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/gyoxuhNh9c7b.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/gyoxuhNh9c7b.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/oh_lagrime,_ch'ad_arte){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Oh lagrime, ch'ad arte
    - aliases: O lagrime, ch'ad arte
    - id: gyoxuhNh9c7b
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/gyoxuhNh9c7b.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [http%3A%2F%2Frepim.unibo.it%2Fresource%2FWORK%2F000380000101_PPPP00011000C](https://repim.itatti.harvard.edu/resource/?uri=http%3A%2F%2Frepim.unibo.it%2Fresource%2FWORK%2F000380000101_PPPP00011000C)
...
???+ abstract "text"
    - Oh lagrime, ch'ad arte<br>
      Ho tante volte sparte in questo Rio,<br>
      Lagrime in cui s'asconde il foco, ond'io<br>
      MI struggo a parte, a parte<br>
      Quando talhor bagnate<br>
      Le delicate membra<br>
      Di colei, che del Ciel Diva rassembra<br>
      Dite lagrime ingrate<br>
      Perché de l'amor mio non l'infiammate?
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/oh_lagrime,_ch'ad_arte/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
