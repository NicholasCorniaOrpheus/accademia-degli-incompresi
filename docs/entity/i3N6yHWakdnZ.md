# Qual ruscello veggiam d'acque sovente (i3N6yHWakdnZ)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/i3N6yHWakdnZ.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/i3N6yHWakdnZ.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/i3N6yHWakdnZ.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/qual_ruscello_veggiam_d'acque_sovente){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Qual ruscello veggiam d'acque sovente
    - id: i3N6yHWakdnZ
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/i3N6yHWakdnZ.json";
    </script>
...
???+ abstract "text"
    - Qual Ruscello veggiam d’acque sovente<br>
      Povero scaturir d’alpestre vena<br>
      Sì, che temprar pòn le sue stille a pena<br>
      Di stanco Peregrin la sete ardente<br>
      <br>
      Ricco di pioggia poi farsi repente<br>
      Superbo sì, che nulla il corso affrena<br>
      Di lui, che'mperioso il tutto mena<br>
      Ampio tributo a l’Ocean possente;<br>
      <br>
      Tal da principio havea debil possanza<br>
      A danno mio questo tiranno Amore,<br>
      E chiese in van de' miei pensier la palma.<br>
      <br>
      Hora sovra'l mio cor tanto s’avanza,<br>
      Che rapido ne porta il suo furore<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/qual_ruscello_veggiam_d'acque_sovente/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
