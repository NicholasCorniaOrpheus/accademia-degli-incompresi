# (Brown 2020) (L2FyhVSPZ7e4)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/L2FyhVSPZ7e4.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/L2FyhVSPZ7e4.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/L2FyhVSPZ7e4.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Brown 2020)
    - aliases: brownDefiningPlaceAcademies2020
    - id: L2FyhVSPZ7e4
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/L2FyhVSPZ7e4.json";
    </script>
...
???+ abstract "citation"
    - Brown, Alison. 2020. ‘Defining the Place of Academies in Florentine Culture and Politics’. In The Italian Academies 1525-1700: Networks of Culture, Innovation and Dissent, edited by Jane E. Everson, Denis V. Reidy, and Lisa Sampson, 22–37. Italian Perspectives 31. London New York: Routledge, Taylor & Francis Group.
