# Da meraviglia il nostro dubbio nasce (SYRcJbuBt6ai)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/SYRcJbuBt6ai.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/SYRcJbuBt6ai.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/SYRcJbuBt6ai.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/da_meraviglia_il_nostro_dubbio_nasce){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Da meraviglia il nostro dubbio nasce
    - id: SYRcJbuBt6ai
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/SYRcJbuBt6ai.json";
    </script>
...
???+ abstract "part of"
    - [Predica de i sogni](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/UoChhqc3tso7)
        * section: Del Dubbio.

???+ abstract "subject"
    - [doubt](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ZkTf74RSPiqC)
...
???+ abstract "text"
    - Da meraviglia il nostro dubbio nasce<br>
      E dal contrasto delle due ragioni;<br>
      Ch'esser dimostran vere le cagioni,<br>
      Di ch'egualmente nostro cor si pasce.<br>
      <br>
      Indi si scopre, e come Sol rinasce<br>
      Tutt'il leggiadro delle inventioni;<br>
      Perché la mente fatti i paragoni,<br>
      Aviva il ver di cui si nutre in fasce.<br>
      <br>
      Grave cos'è levar il dubbio antico,<br>
      Ma il saggio dubitar sospeso tiene,<br>
      L'intelletto disposto, è al vero amico.<br>
      <br>
      Così la negation ardita viene<br>
      Di quel, che è torto, & al dover nimico:<br>
      O vero l'affermar di quel, ch'è bene.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/da_meraviglia_il_nostro_dubbio_nasce/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
