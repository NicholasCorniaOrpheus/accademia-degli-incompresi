# (Brown 2020) (ZGAnrRomGkLX)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/ZGAnrRomGkLX.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/ZGAnrRomGkLX.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/ZGAnrRomGkLX.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Brown 2020)
    - citation: Brown, Alison. 2020. ‘Defining the Place of Academies in Florentine Culture and Politics’. In The Italian Academies 1525-1700: Networks of Culture, Innovation and Dissent, edited by Jane E. Everson, Denis V. Reidy, and Lisa Sampson, 22–37. Italian Perspectives 31. London New York: Routledge, Taylor & Francis Group.
    - id: ZGAnrRomGkLX
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/ZGAnrRomGkLX.json";
    </script>
