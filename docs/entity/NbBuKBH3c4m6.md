# Cantava un giorno la mia Nimpha, quando (NbBuKBH3c4m6)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/NbBuKBH3c4m6.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/NbBuKBH3c4m6.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/NbBuKBH3c4m6.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/accademia-degli-incompresi/assets/poems/cantava_un_giorno_la_mia_nimpha,_quando){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Cantava un giorno la mia Nimpha, quando
    - id: NbBuKBH3c4m6
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/NbBuKBH3c4m6.json";
    </script>
...
???+ abstract "part of"
    - [Quinte Rime della signora Laura Terracina detta Phebea nell'Academia de gl'Incogniti](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/2TJweZdSVTg3)
        * section: Alla S. Dianora Terracina.
        * pages: 22
...
???+ abstract "depicts"
    ...
    - [lyre](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/nTWzEHXADtv4)

???+ abstract "text"
    - Cantava un giorno la mia Nimpha, quando<br>
      Riprese Apollo in man l'amata lira;<br>
      E sì gioioso a la sua voce mira,<br>
      Che'l carro al più bel corso ha posto in bando.<br>
      <br>
      Io che tal'odo anchor, bramosa n'andò<br>
      Ove l'altero suon dolce mi tira:<br>
      E con quella armonia che'l core aggira<br>
      Mi va quasi col corpo al ciel portando.<br>
      <br>
      E benché nel partir habbia gran pena<br>
      Per lasciar qui di mei pensier'il pondo<br>
      Godo pur, ch'altra , non qual'era i sono.<br>
      <br>
      Così tremante e d'allegrezza piena,<br>
      Lodo sovente il gran fattor del mondo:<br>
      Che tra noi die' sì glorioso dono.
...
window.kbGraphConfig.assets = {
  ...
  local_path: "assets/poems/cantava_un_giorno_la_mia_nimpha,_quando/",
