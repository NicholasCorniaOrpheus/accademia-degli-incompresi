# Quando il Sol torna al Cancro, e cangiat'hanno (XhQB27hcAyDv)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/XhQB27hcAyDv.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/XhQB27hcAyDv.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/XhQB27hcAyDv.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/quando_il_sol_torna_al_cancro,_e_cangiat'hanno){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Quando il Sol torna al Cancro, e cangiat'hanno
    - id: XhQB27hcAyDv
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/XhQB27hcAyDv.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [5723](https://lyra.unil.ch/poems/5723)
...
???+ abstract "contributor"
    - [Pietro Gradenigo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/hJLt5YvPFGMq)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)

???+ abstract "part of"
    - [De le rime di diuersi nobili poeti toscani, raccolte da m. Dionigi Atanagi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ZLkECjPHfxmg)
        * volume: 2
        * pages: 98
...
???+ abstract "depicts"
    ...
    - [natural spring](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/82udY6Qaxxsk)

???+ abstract "text"
    - Quando il Sol torna al Cancro, e cangiat'hanno<br>
      Le bionde spiche in bianco il verde vivo;<br>
      A pastor lassi il gran fervore estivo<br>
      Tempran le piante, che spess'ombra fanno:<br>
      <br>
      E gli stanchi corrier, ch'in fretta vanno;<br>
      Scoprono allegri una fontana, o un rivo:<br>
      Onde bevendo, un breve, fuggitivo<br>
      Riposo prendon del passato affanno.<br>
      <br>
      Così quest'alma travagliata, e lassa<br>
      Ne l'amoroso ardor s'adagia, e posa<br>
      A l'ombra vostra, al fonte di pietade:<br>
      <br>
      In qual tempra la sete, ma non lassa<br>
      Satia giamai la mia voglia bramosa<br>
      De le dolci acque, e de l'alma beltade.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/quando_il_sol_torna_al_cancro,_e_cangiat'hanno/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
