# Formaggiata di Sere Stentato al serenissimo re della virtude (ms8gPx8YCcvX)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/ms8gPx8YCcvX.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/ms8gPx8YCcvX.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/ms8gPx8YCcvX.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Formaggiata di Sere Stentato al serenissimo re della virtude
    - id: ms8gPx8YCcvX
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/ms8gPx8YCcvX.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE062656](https://edit16.iccu.sbn.it/titolo/CNCE062656)
...
???+ abstract "has version"
    - 
        * permalink: [CNCE062656](https://edit16.iccu.sbn.it/titolo/CNCE062656)
        * publication date: 1542
        * publisher: [Gabriele Giolito de' Ferrari](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/kPrL7ynGz3pD)
        * external source: [J3VJizH9rHkC](https://books.google.it/books?id=J3VJizH9rHkC)
        * place of publication: [Venezia](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/EGz32eyHGUME) ; [Piacenza](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/EBNVjBhvJDJr)
        * IIIF manifest: [content](https://dl.unito.it/fedora/objects/mag:38161/datastreams/MMIIIF/content)

???+ abstract "contributor"
    - None
    - [Anton Francesco Doni](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/5CefMUJjDKoh)
        * role: [publisher](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/GN4fVhFUAkWg)
...
???+ abstract "subject"
    - [heterodoxy](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/GNdJWQnbJjp6)
    - [satire](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/NgrM4Da6v2fj)
...
??? abstract "Digitised images"
      ...
      <script>
        ...
        local_path: "/",
        images: [],
        iiif: "https://dl.unito.it/fedora/objects/mag:38161/datastreams/MMIIIF/content"
        };
      </script>
