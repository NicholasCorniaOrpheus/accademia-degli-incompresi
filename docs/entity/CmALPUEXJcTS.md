# Filli. Dimmi, lasso, mio core (Savioli) (CmALPUEXJcTS)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/CmALPUEXJcTS.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/CmALPUEXJcTS.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/CmALPUEXJcTS.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/music_compositions/savioli-filli._dimmi,_lasso,_mio_core){ .md-button }
...
!!! note "metadata"
    ...
    - label: Filli. Dimmi, lasso, mio core (Savioli)
    - id: CmALPUEXJcTS
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/CmALPUEXJcTS.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [075290000010101_000000220400C](https://repim.itatti.harvard.edu/resource/?uri=http://repim.unibo.it/resource/WORK/075290000010101_000000220400C)
...
???+ abstract "part of"
    - [Madrigali a cinque voci di Alessandro Savioli. Libro secondo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/5afKJLwbco45)

???+ abstract "based on"
    - [Filli. Dimmi, lasso, mio core](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/EUCsZc7rQDmj)
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/music_compositions/savioli-filli._dimmi,_lasso,_mio_core/",
