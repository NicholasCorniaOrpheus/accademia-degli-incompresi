# Dell'arte rappresentativa premeditata, ed all'improviso (busj5N7wko8B)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/busj5N7wko8B.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/busj5N7wko8B.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/busj5N7wko8B.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Dell'arte rappresentativa premeditata, ed all'improviso
    - id: busj5N7wko8B
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/busj5N7wko8B.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [VEAE003733](http://id.sbn.it/bid/VEAE003733)
...
???+ abstract "title"
    - Dell'arte rappresentativa premeditata, ed all'improviso parti due. Giovevole non solo a chi si diletta di rappresentare; ma a' predicatori, oratori, accademici, e curiosi del dottor Andrea Perrucci
...
???+ abstract "has version"
    - 
        ...
        * permalink: [VEAE003733](http://id.sbn.it/bid/VEAE003733)
