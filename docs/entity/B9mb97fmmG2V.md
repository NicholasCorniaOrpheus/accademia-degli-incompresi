# Fate in me quel si puote o cieli o sorte (B9mb97fmmG2V)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/B9mb97fmmG2V.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/B9mb97fmmG2V.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/B9mb97fmmG2V.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/fate_in_me_quel_che_si_puote_o_cieli_o_sorte){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Fate in me quel si puote o cieli o sorte
    - id: B9mb97fmmG2V
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/B9mb97fmmG2V.json";
    </script>
...
???+ abstract "part of"
    - [Rime de la signora Laura Terracina](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/QHQNCAeFLdvH)
        * pages: 16
        * section: Alla S. Dianora Terracina. Sorella Carissima.

???+ abstract "subject"
    - [perseverance](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/jNVGi7b6DTsP)
    - [loyalty](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/PgcFuPe2GzQH)
...
???+ abstract "text"
    - Fate in me quel si puote o cieli o sorte;<br>
      Et fiammi contra tutti i vostri inganni;<br>
      Che un voler manterrò fino a la morte,<br>
      Un cor & un pensier fra tanti affanni.<br>
      Starò nell'esser mio costante e forte,<br>
      Così ne i primi, qual ne gli ultimi anni:<br>
      Anzi morrò, se ben il ver s'estima,<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/fate_in_me_quel_che_si_puote_o_cieli_o_sorte/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
