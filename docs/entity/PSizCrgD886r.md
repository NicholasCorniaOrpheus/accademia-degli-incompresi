# Marc'Antonio Pordenone (PSizCrgD886r)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/PSizCrgD886r.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/PSizCrgD886r.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/PSizCrgD886r.csv){ .md-button }
...
!!! note "metadata"
    - class: Agent
    - label: Marc'Antonio Pordenone
    - aliases: Marc'Antonio Pordenon; Marc'Antonio Da Pordenone
    - id: PSizCrgD886r
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/PSizCrgD886r.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q28468481](http://www.wikidata.org/entity/Q28468481)
