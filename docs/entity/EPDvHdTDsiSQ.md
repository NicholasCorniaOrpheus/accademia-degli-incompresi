# Tosto che'l sol si scopre in orïente (EPDvHdTDsiSQ)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/EPDvHdTDsiSQ.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/EPDvHdTDsiSQ.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/EPDvHdTDsiSQ.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Tosto che'l sol si scopre in orïente
    - id: EPDvHdTDsiSQ
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/EPDvHdTDsiSQ.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [073400000101_PPPP00130600C](https://repim.itatti.harvard.edu/resource/?uri=http://repim.unibo.it/resource/WORK/073400000101_PPPP00130600C)
...
???+ abstract "text"
    - Tosto che'l sol si scopre in orïente<br>
      Lagrimosa tempesta agli occhi sorge,<br>
      Né perché si ricopra in occidente<br>
      Tregua al mio lagrimar la doglia porge.<br>
      Splendan le stell'o sian dal giorno spente<br>
      Sempre più vivo il pianto mio risorge;<br>
      O sia torbida l'ora o sia tranquilla<br>
