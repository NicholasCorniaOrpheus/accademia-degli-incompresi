# Rime de gli Academici Occulti con le loro imprese et discorsi (PpFwDZxvSFh4)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/PpFwDZxvSFh4.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/PpFwDZxvSFh4.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/PpFwDZxvSFh4.csv){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/PpFwDZxvSFh4.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE000055](https://edit16.iccu.sbn.it/titolo/CNCE000055)
    - [54](https://lyra.unil.ch/books/54)
...
???+ abstract "has version"
    - 
        * external source: [30mui6lEM7AC](https://books.google.it/books?id=30mui6lEM7AC)
        * place of publication: [Brescia](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/HSUADGqRMkDs)
        * publication date: 1568
        * publisher: [Vincenzo Sabbio](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/XnUdBvDRCTEx)
        * permalink: [CNCE000055](https://edit16.iccu.sbn.it/titolo/CNCE000055)
        * IIIF manifest: [manifest](https://brixiana.jarvis.memooria.org/meta/iiif/fd75878a-3138-40e3-9410-d16e70c85213/manifest)
