# initiation ritual (FrTGfpLK9YYC)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/FrTGfpLK9YYC.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/FrTGfpLK9YYC.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/FrTGfpLK9YYC.csv){ .md-button }
...
!!! note "metadata"
    ...
    - description: rite of passage marking entrance or acceptance into a group or society
    - aliases: rite-de-passage; rito di iniziazione
    - id: FrTGfpLK9YYC
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/FrTGfpLK9YYC.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q594939](http://www.wikidata.org/entity/Q594939)
