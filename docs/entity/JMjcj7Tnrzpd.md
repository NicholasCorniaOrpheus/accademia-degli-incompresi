# La bella Flora, che da voi sol spera (JMjcj7Tnrzpd)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/JMjcj7Tnrzpd.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/JMjcj7Tnrzpd.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/JMjcj7Tnrzpd.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/la_bella_flora,_che_da_voi_sol_spera){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: La bella Flora, che da voi sol spera
    - id: JMjcj7Tnrzpd
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/JMjcj7Tnrzpd.json";
    </script>
...
???+ abstract "depicts"
    - [Flora](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/mX4T7bUY98fM)

???+ abstract "text"
    - La bella Flora, che da voi sol spera<br>
      Famosi Heroi, e libertate e pace,<br>
      Fra speranza, e timor si strugge e sface;<br>
      E spesso dice hor mansueta, hor fera:<br>
      <br>
      Oh de' miei figli saggia e prima schiera<br>
      Perché di non seguir l'orme vi piace<br>
      Di chi col ferro, e con la mano audace<br>
      Vi fe' al mio scampo aperta strada e vera?<br>
      <br>
      Perché sì tardi al mio soccorso andate?<br>
      Già non produssi voi liberi e lieti<br>
      Perché lasciaste me serva, e dolente.<br>
      <br>
      Quanta sia in voi virtù dunque mostrate<br>
      E col consiglio, e con la man possente<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/la_bella_flora,_che_da_voi_sol_spera/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
