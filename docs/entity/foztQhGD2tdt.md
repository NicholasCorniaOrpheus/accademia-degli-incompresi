# Giovanni Battista Dalla Gostena (foztQhGD2tdt)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/foztQhGD2tdt.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/foztQhGD2tdt.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/foztQhGD2tdt.csv){ .md-button }
...
!!! note "metadata"
    - class: Agent
    - label: Giovanni Battista Dalla Gostena
    - id: foztQhGD2tdt
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/foztQhGD2tdt.json";
    </script>
...
???+ abstract "occupation"
    - [lutenist](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/8uNecr89dfWA)
    - [composer](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/h24pafkqqHsZ)

???+ abstract "identifier"
    - [Q1525859](http://www.wikidata.org/entity/Q1525859)
