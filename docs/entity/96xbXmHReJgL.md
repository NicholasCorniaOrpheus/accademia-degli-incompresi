# Di Giulio Fiesco il primo libro di madrigali a quattro voci, (96xbXmHReJgL)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/96xbXmHReJgL.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/96xbXmHReJgL.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/96xbXmHReJgL.csv){ .md-button }
...
!!! note "metadata"
    - class: NotatedMusic
    - label: Di Giulio Fiesco il primo libro di madrigali a quattro voci,
    - id: 96xbXmHReJgL
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/96xbXmHReJgL.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [990017938](https://rism.online/sources/990017938)
    - [MUS0132078](http://id.sbn.it/bid/MUS0132078)

???+ abstract "instance of"
    - [partbook](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/hGZbeqwxbiop)

???+ abstract "title"
    - Di Giulio Fiesco il primo libro di madrigali a quattro voci, nouamente da lui composti, & da Antonio Gardane con somma diligentia stampati, & dati in luce

???+ abstract "has version"
    - 
        * permalink: [MUS0132078](http://id.sbn.it/bid/MUS0132078)
        ...
        * external source: [bsb00071908](https://stimmbuecher.digitale-sammlungen.de/view?id=bsb00071908)
        * IIIF manifest: [manifest](https://api.digitale-sammlungen.de/iiif/presentation/v2/bsb00071908/manifest)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://api.digitale-sammlungen.de/iiif/presentation/v2/bsb00071908/manifest"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://api.digitale-sammlungen.de/iiif/presentation/v2/bsb00071908/manifest"]
  };
</script>
