# (Cox 2020) (9n42gMvHpXdx)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/9n42gMvHpXdx.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/9n42gMvHpXdx.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/9n42gMvHpXdx.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Cox 2020)
    - aliases: coxMembersMusesMascots2020
    - id: 9n42gMvHpXdx
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/9n42gMvHpXdx.json";
    </script>
...
???+ abstract "citation"
    - Cox, Virginia. 2020. ‘Members, Muses, Mascots: Women and Italian Academies’. In The Italian Academies 1525-1700: Networks of Culture, Innovation and Dissent, edited by Denis V Reidy, Jane E. Everson, and Lisa Sampson, 150–87. Italian Perspectives 31. London New York: Routledge, Taylor & Francis Group.
