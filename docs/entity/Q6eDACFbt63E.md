# Costei, che in Cipro nacque, e Calidora (Q6eDACFbt63E)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/Q6eDACFbt63E.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/Q6eDACFbt63E.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/Q6eDACFbt63E.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/costei,_che_in_cipro_nacque,_e_calidora){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Costei, che in Cipro nacque, e Calidora
    - id: Q6eDACFbt63E
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/Q6eDACFbt63E.json";
    </script>
...
???+ abstract "depicts"
    ...
    - [Calidora](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/Q4VvxVy3Qz9k)

???+ abstract "language"
    - [Italian](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/85kGqMwffVs7)

???+ abstract "text"
    - Costei, che in Cipro nacque, e Calidora<br>
      E detta, e sposa a Celebino il Duce;<br>
      Non pur di vaghe rose il volto infiora,<br>
      E con un più bel Sol ne gli occhi luce,<br>
      Ma la schiera gentil donnesca honora,<br>
      Con me caduca, e più mirabil luce:<br>
      Così d'ogni arte liberal nomata,<br>
      E con maschio valor femina ornata.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/costei,_che_in_cipro_nacque,_e_calidora/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
