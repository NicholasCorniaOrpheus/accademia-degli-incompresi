# La seconda libraria del Doni (AZUuugS8RJF9)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/AZUuugS8RJF9.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/AZUuugS8RJF9.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/AZUuugS8RJF9.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: La seconda libraria del Doni
    - description: Alphabetic list of academies and their members, some of them fictive.
    - id: AZUuugS8RJF9
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/AZUuugS8RJF9.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE017686](https://edit16.iccu.sbn.it/titolo/CNCE017686)
...
???+ abstract "has version"
    - 
        ...
        * permalink: [CNCE017686](https://edit16.iccu.sbn.it/titolo/CNCE017686)
        * external source: [jlX8x6ARFJsC](https://books.google.it/books?id=jlX8x6ARFJsC)
