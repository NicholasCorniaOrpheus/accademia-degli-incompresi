# A che Plinio, ti duoli, e ti lamenti (AW3Ebna8H4Wv)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/AW3Ebna8H4Wv.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/AW3Ebna8H4Wv.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/AW3Ebna8H4Wv.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/a_che_plinio,_ti_duoli,_e_ti_lamenti){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: A che Plinio, ti duoli, e ti lamenti
    - id: AW3Ebna8H4Wv
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/AW3Ebna8H4Wv.json";
    </script>
...
???+ abstract "text"
    - A che Plinio, ti duoli, e ti lamenti,<br>
      Con interrotti accenti?<br>
      E che pianti di Cigni, e che funeste<br>
      Insegne, ohimè, son queste?<br>
      Forse il tuo Brescia è morto, e i tuoi contenti?<br>
      Con infelice sorte,<br>
      Quasi Cigno ei cantò vicino a morte,<br>
      E fu la Morte ingrata,<br>
      E più che mai spietata,<br>
      S'have la nostra gioia e spenta, e cassa:<br>
      Sembrò ei celeste in Terra,<br>
      Ed r fa al tempo guerra:<br>
      Ah non è morto, dorme, il pianto lassa<br>
      Per non destarlo, e taci, e mira, e passa.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/a_che_plinio,_ti_duoli,_e_ti_lamenti/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
