# Accademia delle Notti Vaticane (2emWSDKWVCxt)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/2emWSDKWVCxt.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/2emWSDKWVCxt.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/2emWSDKWVCxt.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Accademia delle Notti Vaticane
    - aliases: Noctes Vaticanae
    - id: 2emWSDKWVCxt
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/2emWSDKWVCxt.json";
    </script>
...
???+ abstract "described by source"
    - [occhipintiSullAccademiaNottiVaticane2017](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/L3HJPhZFXcTh)

???+ abstract "inception"
    - 1562-04-21
        * reference: [occhipintiSullAccademiaNottiVaticane2017](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/L3HJPhZFXcTh)
...
???+ abstract "member"
    - [Agostino Valier](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/cvUfQCyS7rjj)
        * reference: [occhipintiSullAccademiaNottiVaticane2017](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/L3HJPhZFXcTh)
        * pseudonym: Obbediente
    - [Sperone Speroni](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/cxRMGudi2EK6)
        * reference: [occhipintiSullAccademiaNottiVaticane2017](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/L3HJPhZFXcTh)
        * pseudonym: Nestore
    - [Silvio Antoniano](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/BN8ks7uWDwiC)
        * reference: [occhipintiSullAccademiaNottiVaticane2017](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/L3HJPhZFXcTh)
        * pseudonym: Risoluto
