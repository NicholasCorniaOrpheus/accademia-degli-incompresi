# Oh dolorosi amanti (dgeVEev2vEhf)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/dgeVEev2vEhf.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/dgeVEev2vEhf.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/dgeVEev2vEhf.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/oh_dolorosi_amanti){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Oh dolorosi amanti
    - aliases: O dolorosi amanti
    - id: dgeVEev2vEhf
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/dgeVEev2vEhf.json";
    </script>
...
???+ abstract "depicts"
    - [lover](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/Q3VtFUAxVKyf)
    - [weeping](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/YNz7hZ7AqXJk)
    - [infinity](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/Aj4KdJ3ijbDF)
    - [chain](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/b4iEGX754ExJ)

???+ abstract "text"
    - Oh dolorosi amanti;<br>
      Che spregiando la vita,<br>
      Solo bramate chi morir v'invita.<br>
      Nudriti sol di pianti,<br>
      D'angoscia, di sospir, d'acerba doglia.<br>
      Et io meschino il provo:<br>
      Che'n tanto mal mi trovo,<br>
      Che l'alma ogn'hora di piacer si spoglia;<br>
      Et con irata voglia<br>
      Gridando dico, oh ciel quando farai,<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/oh_dolorosi_amanti/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
