# Dialogo sopra la particolare dichiaratione del giuoco di Pitagora (mCuvDnsUYbDe)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/mCuvDnsUYbDe.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/mCuvDnsUYbDe.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/mCuvDnsUYbDe.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Dialogo sopra la particolare dichiaratione del giuoco di Pitagora
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/mCuvDnsUYbDe.json";
    </script>
...
???+ abstract "described by source"
    - [(Geremicca 2017)](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/3XnpJ3vZQnbp)

???+ abstract "instance of"
    - [manuscript](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/HXQyc85NviAY)

???+ abstract "title"
    - Trattato delle proportioni et proportionalità; Dialogo sopra la particolare dichiaratione del giuoco di Pitagora inter locutori Carlo Strozzi, Cosimo Rucellai, et Iacopo Vettori
...
???+ abstract "has version"
    - 
        * permalink: [1cbab6fe-218a-471e-9f81-f7ef048c6dfa](https://digitalcollections.library.upenn.edu/items/1cbab6fe-218a-471e-9f81-f7ef048c6dfa)
        * publication date: 1539
        * IIIF manifest: [manifest](https://colenda.library.upenn.edu/items/ark:/81431/p3c95d/manifest)
        * holding institution: [University of Pennsylvania](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/U9abjoAUvN2q)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://colenda.library.upenn.edu/items/ark:/81431/p3c95d/manifest"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://colenda.library.upenn.edu/items/ark:/81431/p3c95d/manifest"]
  };
</script>
