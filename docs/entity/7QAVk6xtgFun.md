# Gli horti del sole. Poemetto del con. Marc'Ant. Ferretti (7QAVk6xtgFun)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/7QAVk6xtgFun.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/7QAVk6xtgFun.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/7QAVk6xtgFun.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Gli horti del sole. Poemetto del con. Marc'Ant. Ferretti
    - id: 7QAVk6xtgFun
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/7QAVk6xtgFun.json";
    </script>
...
???+ abstract "title"
    - Gli horti del sole. Poemetto del con. Marc'Ant. Ferretti. Al serenissimo Federico prencipe d'Vrbino

???+ abstract "has version"
    - 
        * permalink: [TO0E008513](http://id.sbn.it/bid/TO0E008513)
        ...
        * publisher: [Alessandro Polo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/MVnDpdgUV9PW)
        * external source: [ObSaJQi0LeQC](https://books.google.be/books?id=ObSaJQi0LeQC)
...
???+ abstract "identifier"
    - [TO0E008513](http://id.sbn.it/bid/TO0E008513)
