# Donna real, nel cui pudico seno (NNQgD68HzN8e)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/NNQgD68HzN8e.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/NNQgD68HzN8e.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/NNQgD68HzN8e.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/donna_real,_nel_cui_pudico_seno){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Donna real, nel cui pudico seno
    - id: NNQgD68HzN8e
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/NNQgD68HzN8e.json";
    </script>
...
???+ abstract "contributor"
    - [Costanza Colonna](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/c6ABW9ysUosu)
...
???+ abstract "part of"
    - [La Scanderbeide poema heroico della signora Margherita Sarrocchi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/AmmUd8Ddd3Qw)
        * section: Alla Signora D. Costanza Colonna Sforza. Margherita Sarocchi.
...
???+ abstract "text"
    - Donna real, nel cui pudico seno<br>
      Sol regna alto pensier d'eterno onore,<br>
      Cui non fe la virtù del forte core<br>
      Venir morte, o unquanco meno:<br>
      <br>
      Tu sola in questo sì del Mondo pieno<br>
      Di perigli, e fatiche in certo errore<br>
      Drizzi i miei torti passi, e il cieco orrore<br>
      Mio sgombri, col tuo Sol puro, e sereno.<br>
      <br>
      Deh ognor benigna al mio desire aspira,<br>
      Che forse mi vedrai l'altero Monte<br>
      Poggiar, dove rado orma oggi si mira.<br>
      <br>
      E al dolce mormorio del sagro fonte<br>
      Temprar le corde alla mia rauca lira,<br>
      E far tue lode, e mie venture conte.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/donna_real,_nel_cui_pudico_seno/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
