# Canto la gran Pietà del Capitano (RjSSAQb2LqAg)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/RjSSAQb2LqAg.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/RjSSAQb2LqAg.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/RjSSAQb2LqAg.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Canto la gran Pietà del Capitano
    - id: RjSSAQb2LqAg
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/RjSSAQb2LqAg.json";
    </script>
...
???+ abstract "contributor"
    - [Paolo Guidotti](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/2crP46brsdr4)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)

???+ abstract "part of"
    - [Gerusalemme distrutta](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/L69SPYimAHct)
        * section: Canto I, 1

???+ abstract "based on"
    - [Canto l'arme pietose, e'l Capitano](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/GhS4fnsNs9Y7)
...
???+ abstract "text"
    - Canto la gran Pietà del Capitano,<br>
      Che l'aspra morte vendicò di Christo,<br>
      Quella Pietà, ch'a lui resse la mano<br>
      Mentre fea di Sion l'altero acquisto;<br>
      Allor c'osò di far oprarla in vano<br>
      Del mondo, e di Stan l'inganno misto<br>
      Permettendo del Ciel gli ordini Santi<br>
      Per più punir gli Israeliti erranti.
