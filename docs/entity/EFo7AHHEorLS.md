# (Terzaghi 2017) (EFo7AHHEorLS)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/EFo7AHHEorLS.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/EFo7AHHEorLS.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/EFo7AHHEorLS.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Terzaghi 2017)
    - aliases: terzaghiLaccademicoOttavioTronsarelli2017
    - id: EFo7AHHEorLS
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/EFo7AHHEorLS.json";
    </script>
...
???+ abstract "citation"
    - Terzaghi, Maria Cristina. 2017. ‘L’accademico Ottavio Tronsarelli e il suo contributo alle Vite di Giovanni Baglione’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Paolo Procaccioli, 195–211. Roma: De Luca editori d’arte.
