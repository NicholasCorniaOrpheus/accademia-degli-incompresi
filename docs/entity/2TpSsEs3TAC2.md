# Oh Bellissimo petto (2TpSsEs3TAC2)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/2TpSsEs3TAC2.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/2TpSsEs3TAC2.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/2TpSsEs3TAC2.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/oh_bellissimo_petto){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/2TpSsEs3TAC2.json";
    </script>
...
???+ abstract "identifier"
    - 
        * https: //repim.itatti.harvard.edu/resource/?uri=http%3A%2F%2Frepim.unibo.it%2Fresource%2FWORK%2F000390000101_PPPP00011000C
...
???+ abstract "depicts"
    - [four temperaments](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/DEzosFymsuXR)

???+ abstract "language"
    - [Italian](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/85kGqMwffVs7)

???+ abstract "text"
    - Oh Bellissimo petto,<br>
      Dolce petto amoroso<br>
      De l'avido mio sguardo altero oggetto<br>
      Per questo caldo humore,<br>
      Ond'hor se'rugiadoso<br>
      Poiché partir convien rendimi il core.<br>
      No no. Fia meglio, ch'io nel duol mi stempre<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/oh_bellissimo_petto/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
