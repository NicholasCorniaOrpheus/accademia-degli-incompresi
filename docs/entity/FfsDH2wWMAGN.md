# lightning (FfsDH2wWMAGN)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/FfsDH2wWMAGN.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/FfsDH2wWMAGN.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/FfsDH2wWMAGN.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: lightning
    - aliases: folgore; fulmine; saetta
    - id: FfsDH2wWMAGN
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/FfsDH2wWMAGN.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q33741](http://www.wikidata.org/entity/Q33741)
