# Amor tu causi tutt'il penar mio (Dattari) (A4TRHbKoHDVm)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/A4TRHbKoHDVm.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/A4TRHbKoHDVm.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/A4TRHbKoHDVm.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/music_compositions/dattari-amor_tu_causi_tutto_il_penar_mio){ .md-button }
...
!!! note "metadata"
    ...
    - label: Amor tu causi tutt'il penar mio (Dattari)
    - id: A4TRHbKoHDVm
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/A4TRHbKoHDVm.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [019850000010101_000000078300C](https://repim.itatti.harvard.edu/resource/?uri=http://repim.unibo.it/resource/WORK/019850000010101_000000078300C)
...
???+ abstract "instance of"
    - [villanella](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/QypSgehNnySf)
...
???+ abstract "based on"
    - [Amor tu causi tutt'il penar mio](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/DScvW8CskarL)
        * note: The lyrics have been substancially changed.

???+ abstract "text"
    - Amor tu causi tutt'il penar mio<br>
      Tu mi fai tort'e non colei ch'adoro<br>
      Ma se tu vuoi ch'io viv'in tal martire<br>
      Fammi più presto pregoti morire.<br>
      <br>
      E se tu dessi effeto al mio desio,<br>
      Havrei nei danni almen qualche ristoro<br>
      Ma se tu vuoi ch'io viv'in tal martire<br>
      Fammi più presto pregoti morire.<br>
      <br>
      Tu fosti sempre un lusinghier d'amore<br>
      E sei caggion, che per amar io moro<br>
      Ma se tu vuoi ch'io viv'in tal martire<br>
      Fammi più presto pregoti morire.<br>
      <br>
      Ma perché tanto al mio soccorso tardi<br>
      S'havut'io n'ho da lei parol'e sguardi<br>
      Tu mi fai star con speme in su la cima,<br>
      E a corre il frutto un'altro serà prima.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/music_compositions/dattari-amor_tu_causi_tutto_il_penar_mio/",
    images: ["b_001.jpg", "c_001.jpg", "t_001.jpg"],
    iiif: []
  };
</script>
