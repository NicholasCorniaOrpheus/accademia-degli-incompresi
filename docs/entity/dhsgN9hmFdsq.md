# improvisational theater (dhsgN9hmFdsq)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/dhsgN9hmFdsq.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/dhsgN9hmFdsq.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/dhsgN9hmFdsq.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: improvisational theater
    - aliases: commedia all'improvviso
    - id: dhsgN9hmFdsq
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/dhsgN9hmFdsq.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q1140700](http://www.wikidata.org/entity/Q1140700)
