# (Moroncini 2020) (mzbsVFUqEnzX)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/mzbsVFUqEnzX.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/mzbsVFUqEnzX.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/mzbsVFUqEnzX.csv){ .md-button }
...
!!! note "metadata"
    ...
    - aliases: moronciniAccademiaVirtuReligious2020
    - id: mzbsVFUqEnzX
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/mzbsVFUqEnzX.json";
    </script>
...
???+ abstract "citation"
    - Moroncini, Ambra. 2020. ‘The Accademia Delle Virtù and Religious Dissent’. In The Italian Academies 1525-1700: Networks of Culture, Innovation and Dissent, edited by Jane E. Everson, Denis V. Reidy, and Lisa Sampson, 88–101. Italian Perspectives 31. London New York: Routledge, Taylor & Francis Group.
