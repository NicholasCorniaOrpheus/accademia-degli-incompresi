# Le immagini del tempio della signora donna Giovanna Aragona (8DWzsnTmBegD)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/8DWzsnTmBegD.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/8DWzsnTmBegD.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/8DWzsnTmBegD.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Le immagini del tempio della signora donna Giovanna Aragona
    - description: (Fictional) dialogues from academic gatherings of salonnière Giovanna d'Aragona.
    - aliases: Le insegne del tempio della signora donna Giovanna d'Aragona
    - id: 8DWzsnTmBegD
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/8DWzsnTmBegD.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE005675](https://edit16.iccu.sbn.it/titolo/CNCE005675)
...
???+ abstract "title"
    - Le imagini del tempio della signora donna Giouanna Aragona, dialogo di m. Giuseppe Betussi

???+ abstract "has version"
    - 
        * permalink: [CNCE005675](https://edit16.iccu.sbn.it/titolo/CNCE005675)
        ...
        * external source: [16076](https://bdt.bibcom.trento.it/Testi-a-stampa/16076)
        * IIIF manifest: [content](https://dl.unito.it/fedora/objects/mag:956/datastreams/MMIIIF/content)
...
???+ abstract "contributor"
    ...
    - [Vittoria Colonna](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dnKqeJdTP2sv)
        * role: [dedicatee](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/5GmrgRoxsCpY)
    - [Giuseppe Betussi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/EZMPVF777dGq)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)
    - [Giovanna d'Aragona](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/PndEj8FtSonb)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://dl.unito.it/fedora/objects/mag:956/datastreams/MMIIIF/content"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://dl.unito.it/fedora/objects/mag:956/datastreams/MMIIIF/content"]
  };
</script>
