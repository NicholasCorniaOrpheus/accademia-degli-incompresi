# Francesco Barozzi (SFLGuQecC5Vm)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/SFLGuQecC5Vm.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/SFLGuQecC5Vm.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/SFLGuQecC5Vm.csv){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/SFLGuQecC5Vm.json";
    </script>
...
???+ abstract "member of"
    - [Accademia dei Vivi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/kFnYroNenQXw)
        * role: [founder](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ZEaRKZPWgMmt)

???+ abstract "occupation"
    - [mathematician](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/R8qBNz9wfWhs)

???+ abstract "notable work"
    - [Rythmomachia](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/2MfyHa7JtBLb)
