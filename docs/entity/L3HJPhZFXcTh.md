# (Occhipinti 2017) (L3HJPhZFXcTh)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/L3HJPhZFXcTh.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/L3HJPhZFXcTh.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/L3HJPhZFXcTh.csv){ .md-button }
...
!!! note "metadata"
    ...
    - citation: Occhipinti, Carmelo. 2017. ‘Sull’Accademia delle Notti Vaticane. Scritti di Carlo Borromeo, Giovanni Battista Amalteo e di altri sodali’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Paolo Procaccioli, 125–37. Roma: De Luca editori d’arte.
    - id: L3HJPhZFXcTh
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/L3HJPhZFXcTh.json";
    </script>
