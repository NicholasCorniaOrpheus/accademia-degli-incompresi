# Oh tante indarno mie fatiche sparse (EC2HTeFPMTwd)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/EC2HTeFPMTwd.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/EC2HTeFPMTwd.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/EC2HTeFPMTwd.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/oh_tante_indarno_mie_fatiche_sparse){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Oh tante indarno mie fatiche sparse
    - id: EC2HTeFPMTwd
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/EC2HTeFPMTwd.json";
    </script>
...
???+ abstract "described by source"
    - [(Broccia 2008)](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/GY8Uax26Ma9G)
...
???+ abstract "text"
    - Oh tante indarno mie fatiche sparse,<br>
      Oh tanti indarno miei sparsi sospiri;<br>
      Oh vivo foco, o fé, che, se ben miri,<br>
      Di tal null'altra mai non alge, & arse.<br>
      <br>
      Oh carte invan vergate, e da vergarse<br>
      Per lodar quegli ardenti amati giri;<br>
      Oh speranze ministre de' disiri,<br>
      A cui premio più degno dovea darse.<br>
      <br>
      Tutte ad un tratto ve ne porta il vento,<br>
      Poiché da l'empio mio Signore stesso<br>
      Con queste proprie orecchie dir mi sento,<br>
      <br>
      Che tanto pensa a me, quanto m'è presso,<br>
      E partendo si parte in un momento<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/oh_tante_indarno_mie_fatiche_sparse/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
