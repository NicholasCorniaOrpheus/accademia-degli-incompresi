# Care gioie, che le noie (Ghizzolo) (HEneBqTPSjJ2)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/HEneBqTPSjJ2.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/HEneBqTPSjJ2.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/HEneBqTPSjJ2.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/music_compositions/ghizzolo-care_gioie,_che_le_noie){ .md-button }
...
!!! note "metadata"
    ...
    - label: Care gioie, che le noie (Ghizzolo)
    - id: HEneBqTPSjJ2
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/HEneBqTPSjJ2.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [038980000010101_000000114800C](https://repim.itatti.harvard.edu/resource/?uri=http://repim.unibo.it/resource/WORK/038980000010101_000000114800C)
...
???+ abstract "contributor"
    ...
    - [Giovanni Ghizzolo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/cxBfmd4dEVpm)
        * role: [composer](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/h24pafkqqHsZ)

???+ abstract "part of"
    - [Canzonette ed arie a tre voci di Gio. Ghizzolo. Libro primo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/kurJaiVM3Miq)

???+ abstract "based on"
    - [Care gioie, che le noie](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dMKFkrqamrJ4)
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/music_compositions/ghizzolo-care_gioie,_che_le_noie/",
    images: ["b_001.jpg", "c2_001.jpg"],
    iiif: []
  };
</script>
