# A voi Donna reale, al vostro immenso (YecU2imEbA4N)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/YecU2imEbA4N.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/YecU2imEbA4N.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/YecU2imEbA4N.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/a_voi_donna_reale,_al_vostro_immenso){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: A voi Donna reale, al vostro immenso
    - id: YecU2imEbA4N
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/YecU2imEbA4N.json";
    </script>
...
???+ abstract "text"
    - A voi Donna reale, al vostro immenso<br>
      Valore, a l'accortezza, a l'honestate,<br>
      A quella serenissima beltate,<br>
      Ond'havete d'amore il mondo incenso,<br>
      <br>
      A l'alta incontra al fato, e'ncontra al senso,<br>
      Costante, inespugnabile humiltate,<br>
      A la vostra divina humanitate<br>
      Erge quest'ara universal consenso.<br>
      <br>
      A cui sacra d'intorno, e la virtute,<br>
      E la gloria de' vostri, e'l nostro merto,<br>
      Tante di vero honor, chiare facelle;<br>
      <br>
      Che le rozze mie Muse, e fredde, e mute,<br>
      Ma solo offrendo, e questo picciol serto,<br>
      Lassan l'Eternità che ne favelle.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/a_voi_donna_reale,_al_vostro_immenso/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
