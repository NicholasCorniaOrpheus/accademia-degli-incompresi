# Poesie e prose, italiane e latine inedite di Francesco Maria, e di Tarquinia Molza, ed altre a loro dirette (bBbzZd2rViTJ)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/bBbzZd2rViTJ.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/bBbzZd2rViTJ.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/bBbzZd2rViTJ.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Poesie e prose, italiane e latine inedite di Francesco Maria, e di Tarquinia Molza, ed altre a loro dirette
    - id: bBbzZd2rViTJ
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/bBbzZd2rViTJ.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [LO1E004175](http://id.sbn.it/bid/LO1E004175)

???+ abstract "instance of"
    - [poetry collection](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/XzeQyQXbyjmR)

???+ abstract "title"
    - 3: Volume terzo, contenente poesie e prose, italiane e latine inedite di Francesco Maria, e di Tarquinia Molza, ed altre a loro dirette

???+ abstract "has version"
    - 
        * permalink: [LO1E004175](http://id.sbn.it/bid/LO1E004175)
        * publication date: 1754
        * place of publication: [Bergamo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dYitBDGB87fT)
        * external source: [xGqzcJOdVaQC](https://books.google.it/books?id=xGqzcJOdVaQC)

???+ abstract "contributor"
    - [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)
        * role: [Tarquinia Molza](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/oVgX4nooPy2A)
