# Questa d'odiar la morte antica usanza (CpLwPf5WkMx6)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/CpLwPf5WkMx6.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/CpLwPf5WkMx6.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/CpLwPf5WkMx6.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Questa d'odiar la morte antica usanza
    - id: CpLwPf5WkMx6
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/CpLwPf5WkMx6.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [15092](https://versologie.cz/poetree/browser/poem?corpus=it&id_poem=15092)
...
???+ abstract "text"
    - Questa d'odiar la morte antica usanza<br>
      Nasce sovente in noi, ciechi mortali,<br>
      Dal non aver sugli omer le grandi ali<br>
      Ferme de la divina alta speranza,<br>
      <br>
      Né 'n quella pietra, ch'ogni stima avanza<br>
      Di sodezza, ma solo in questi frali<br>
      Fondamenti di rena, a tutti i mali<br>
      Exposti, edificar la nostra stanza;<br>
      <br>
      Onde con fede ancor per grazia spera<br>
      L'alma in Dio forte aver per segno caro<br>
      Quella ch'ai più superbi è più nimica,<br>
      <br>
      E non che sia col braccio empio ed avaro<br>
      De le mie spoglie lieta, anzi io sia altera<br>
