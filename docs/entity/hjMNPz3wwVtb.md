# Ragionamento di Luca Contile sopra la proprietà delle imprese con le particolari de gli Academici Affidati et con le interpretationi et croniche (hjMNPz3wwVtb)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/hjMNPz3wwVtb.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/hjMNPz3wwVtb.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/hjMNPz3wwVtb.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Ragionamento di Luca Contile sopra la proprietà delle imprese con le particolari de gli Academici Affidati et con le interpretationi et croniche
    - id: hjMNPz3wwVtb
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/hjMNPz3wwVtb.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [CNCE013187](https://edit16.iccu.sbn.it/titolo/CNCE013187)
        * place of publication: [Pavia](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/5bXhk8iPrKqE)
        * publication date: 1574
        * external source: [10A13998](https://viewer.onb.ac.at/10A13998/)
        * IIIF manifest: [10A13998](https://api.onb.ac.at/iiif/presentation/v3/manifest/10A13998)
        * publisher: [Girolamo Bartoli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/FAjDAyPWAxLj)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://api.onb.ac.at/iiif/presentation/v3/manifest/10A13998"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://api.onb.ac.at/iiif/presentation/v3/manifest/10A13998"]
  };
</script>
