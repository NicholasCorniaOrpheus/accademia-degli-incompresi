# Sciogli la lingua al canto, e leghi i cori (NoqaiA4U5TQu)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/NoqaiA4U5TQu.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/NoqaiA4U5TQu.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/NoqaiA4U5TQu.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/accademia-degli-incompresi/assets/poems/sciogli_la_lingua_al_canto,_e_leghi_i_cori){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Sciogli la lingua al canto, e leghi i cori
    - id: NoqaiA4U5TQu
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/NoqaiA4U5TQu.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [Prospero Polelli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/NQyFBGWtNeGZ)
...
???+ abstract "text"
    - Sciogli la lingua al canto, e leghi i cori,<br>
      E scopri in carte anguste angusta vena,<br>
      Mentre di lui, che l'Universo affrena,<br>
      Spieghi in sì dolce stil gli aspri dolori.<br>
      <br>
      D'impuri no, ma di pudici ardori<br>
      Di magnanimi Eroi tua mente è piena,<br>
      Onde in contar di lor l'acerba pena,<br>
      Le spine ingemmi, e'l duro ferro indori.<br>
      <br>
      Come in gioia si cangi il duol profondo,<br>
      La morte in vita, in luce ombre funeste,<br>
      Mostra il tuo stile oltre ogni stil facondo.<br>
      <br>
      Così spirto immortale in mortal veste,<br>
      Mentre ti celi altri, ti scopri al Mondo<br>
      In terreno sembiante Orfeo celeste.
...
window.kbGraphConfig.assets = {
  ...
  local_path: "assets/poems/sciogli_la_lingua_al_canto,_e_leghi_i_cori/",
  images: ["001.jpg"],
  iiif: []
};
</script>
