# (Girotto 2017) (ZifaaoQeYVLT)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/ZifaaoQeYVLT.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/ZifaaoQeYVLT.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/ZifaaoQeYVLT.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Girotto 2017)
    - aliases: girottoAccademieDiAnton2017
    - id: ZifaaoQeYVLT
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/ZifaaoQeYVLT.json";
    </script>
...
???+ abstract "citation"
    - Girotto, Carlo Alberto. 2017. ‘Le accademie di Anton Francesco Doni’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 27–37. Roma: De Luca editori d’arte.
