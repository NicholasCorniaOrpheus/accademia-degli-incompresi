# Giovan Leonardo Primavera (ArJYyGJhPBWu)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/ArJYyGJhPBWu.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/ArJYyGJhPBWu.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/ArJYyGJhPBWu.csv){ .md-button }
...
!!! note "metadata"
    - class: Agent
    - label: Giovan Leonardo Primavera
    - id: ArJYyGJhPBWu
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/ArJYyGJhPBWu.json";
    </script>
...
???+ abstract "identifier"
    - [Q5563608](http://www.wikidata.org/entity/Q5563608)
