# Hoggi, s'Io non m'inganno, è giunto il giorno (3i7Q5kbgQ2N4)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/3i7Q5kbgQ2N4.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/3i7Q5kbgQ2N4.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/3i7Q5kbgQ2N4.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/accademia-degli-incompresi/assets/poems/hoggi,_s'io_non_m'inganno,_è_giunto_il_giorno){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Hoggi, s'Io non m'inganno, è giunto il giorno
    - aliases: Oggi, s'Io non m'inganno, è giunto il giorno
    - id: 3i7Q5kbgQ2N4
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/3i7Q5kbgQ2N4.json";
    </script>
...
???+ abstract "contributor"
    - [Maria Diamante Dolfi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ivYChgZ7D5aD)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)

???+ abstract "part of"
    - [Rime diverse d'alcune nobilissime, et virtuosissime donne](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/KsqUZ8dKXxDW)
        * section: Di Mad. Diamante Dolfi.
        * pages: 42
...
???+ abstract "text"
    - Hoggi, s'Io non m'inganno, è giunto il giorno,<br>
      In cui dee Potria mia co' rai lucenti<br>
      Rischiarar l'aria, & rallegrar le genti,<br>
      Et forse empiere il ciel d'invidia, & scorno.<br>
      <br>
      Già nel suo più leggiadro habito adorno<br>
      Veggiola uscir del nido, e i fiumi, e i venti<br>
      Fermar col riso a rimirarla intenti,<br>
      E insieme hor questi, hor quei stupirle intorno.<br>
      <br>
      Veggiola poi nel sacro tempio assisa,<br>
      Prima devota il Fattor santo adora;<br>
      Poscia i bei lumi honesti intorno gira.<br>
      <br>
      Ahi che pur scorgo il suo pensiero anchora:<br>
      Duolsi, che; mentre hor quinci, hor quindi affisa<br>
      Gli occhi; fra tante Me con Lei non mira.
...
window.kbGraphConfig.assets = {
  ...
  local_path: "assets/poems/hoggi,_s'io_non_m'inganno,_è_giunto_il_giorno/",
  images: ["001.jpg"],
  iiif: []
};
</script>
