# Il primo libro dell'opere toscane di m. Laura Battiferra degli Ammannati (3gZsxzoV4qay)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/3gZsxzoV4qay.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/3gZsxzoV4qay.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/3gZsxzoV4qay.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Il primo libro dell'opere toscane di m. Laura Battiferra degli Ammannati
    - id: 3gZsxzoV4qay
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/3gZsxzoV4qay.json";
    </script>
...
???+ abstract "title"
    - Il primo libro dell'opere toscane di m. Laura Battiferra degli Ammannati

???+ abstract "has version"
    - 
        * external source: [702IlHGGFyoC](https://books.google.be/books?id=702IlHGGFyoC)
        ...
        * publisher: [Bernardo Giunti](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/irdFWnrUWMtD)
        * permalink: [CNCE004630](https://edit16.iccu.sbn.it/titolo/CNCE004630)
