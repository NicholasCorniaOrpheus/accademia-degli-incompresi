# Orlando furioso (FSsfkMyDLbzE)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/FSsfkMyDLbzE.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/FSsfkMyDLbzE.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/FSsfkMyDLbzE.csv){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/FSsfkMyDLbzE.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q48922](http://www.wikidata.org/entity/Q48922)
...
???+ abstract "has version"
    - 
        ...
        * permalink: [CNCE002566](https://edit16.iccu.sbn.it/titolo/CNCE002566)
        * note: Final edition, including extra canti.
        * publication date: 1532
    - 
        * permalink: [CNCE002541](https://edit16.iccu.sbn.it/titolo/CNCE002541)
        * note: First edtion.
        * place of publication: [Ferrara](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/Ut5gfQdSP4WR)
