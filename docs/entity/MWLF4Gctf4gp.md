# Di Luca Marenzio il terzo libro de madrigali a cinque voci (MWLF4Gctf4gp)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/MWLF4Gctf4gp.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/MWLF4Gctf4gp.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/MWLF4Gctf4gp.csv){ .md-button }
...
!!! note "metadata"
    - class: NotatedMusic
    - label: Di Luca Marenzio il terzo libro de madrigali a cinque voci
    - id: MWLF4Gctf4gp
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/MWLF4Gctf4gp.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE045282](https://edit16.iccu.sbn.it/titolo/CNCE045282)

???+ abstract "instance of"
    - [[partbook]]

???+ abstract "title"
    - Di Luca Marenzio il terzo libro de madrigali a cinque voci. Nouamente composti & dati in luce

???+ abstract "has version"
    - 
        * permalink: [CNCE045282](https://edit16.iccu.sbn.it/titolo/CNCE045282)
        ...
        * external source: [bsb00083511](https://stimmbuecher.digitale-sammlungen.de/view?id=bsb00083511)
        * IIIF manifest: [manifest](https://api.digitale-sammlungen.de/iiif/presentation/v2/bsb00083511/manifest)
