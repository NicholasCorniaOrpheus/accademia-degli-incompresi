# Già l'alma ti donai (FRHyC2RRbdQm)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/FRHyC2RRbdQm.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/FRHyC2RRbdQm.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/FRHyC2RRbdQm.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/già_l'alma_ti_donai){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/FRHyC2RRbdQm.json";
    </script>
...
???+ abstract "part of"
    - [Il Gareggiamento poetico del Confuso Accademico Ordito](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/MW7UE9R8m7LS)
        * section: Fede Rotta. Alla Illustre Signora Lucietta da l"oca Spinelli. Isabella Andreini
        * pages: 179
        * volume: 5

???+ abstract "subject"
    - [departure](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/HfQkYfWDVNZC)
...
???+ abstract "text"
    - Già l'alma ti donai<br>
      Vivendo sol de la tua vista lieta;<br>
      Ma poi che rio pianeta<br>
      Mi costrinse a partire,<br>
      Per non vedermi inanzi a te morire<br>
      Pietoso mi dicesti<br>
      Vivi oh mia Filli, e l'alma mi rendesti.<br>
      Hor perché di te priva<br>
      Questa vita m'è schiva,<br>
      E sol morir desio<br>
      La dolent'alma a te di novo invio.

???+ abstract "identifier"
    - [078890000101_PPPP00011000C](https://repim.itatti.harvard.edu/resource/?uri=http://repim.unibo.it/resource/WORK/078890000101_PPPP00011000C)
    - [20881](https://lyra.unil.ch/poems/20881)
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/già_l'alma_ti_donai/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
