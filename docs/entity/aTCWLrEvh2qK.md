# Infelice Signor, hor questo è'l merto (aTCWLrEvh2qK)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/aTCWLrEvh2qK.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/aTCWLrEvh2qK.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/aTCWLrEvh2qK.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/infelice_signor,_hor_questo_è'l_merto){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Infelice Signor, hor questo è'l merto
    - id: aTCWLrEvh2qK
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/aTCWLrEvh2qK.json";
    </script>
...
???+ abstract "contributor"
    - [Ridolfo Campeggi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/2Pdscgmu8bbW)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)

???+ abstract "part of"
    - [La distruzione di Gierusalemme](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/gQfPLJXEVPsT)
        * section: 7
        * pages: 6
...
???+ abstract "text"
    - Infelice Signor, hor questo è'l merto,<br>
      Che della tua bontà fra noi riporti,<br>
      Per aprirci il camin scosceso, & erto<br>
      Di gire al Ciel, quai pene, ahi non sopporti?<br>
      Perché mostrasti il tuo potere aperto,<br>
      Sanando gl'egri, e ravvivando i morti,<br>
      Sarai costretto dallo stuol feroce<br>
      Lasciar il corpo essanimato in Croce.
