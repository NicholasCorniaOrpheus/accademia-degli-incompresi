# Scema il tempo fugace ogni martire (Gw6f5tSKEnrx)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/Gw6f5tSKEnrx.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/Gw6f5tSKEnrx.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/Gw6f5tSKEnrx.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/scema_il_tempo_fugace_ogni_martire){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Scema il tempo fugace ogni martire
    - id: Gw6f5tSKEnrx
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/Gw6f5tSKEnrx.json";
    </script>
...
???+ abstract "part of"
    - [Rime diverse d'alcune nobilissime, et virtuosissime donne](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/KsqUZ8dKXxDW)
        * section: Di Mad. Virginia Martini de' Salvi, Senese.
        * pages: 162
...
???+ abstract "text"
    - Scema il tempo fugace ogni martire;<br>
      Così può ravvivar la Morte speme,<br>
      Et far minore il mal, che l'alma preme,<br>
      Per cui s'appaga poi l'altrui desire.<br>
      <br>
      Con maggior forza in Me prende suo ardire<br>
      Il grave duol, che con la vita insieme<br>
      Sen'va; né pria, che giunta a l'hore estreme<br>
      Spero, c'habbia a scemar, non che a finire.<br>
      <br>
      Che, se di giorno in giorno più risplende<br>
      La virtù del mio Sol senz'altra eguale,<br>
      Né volger d'hore, o Morte pur l'offende;<br>
      <br>
      Come può il tempo far minore il male<br>
      Nel cor mio, che d'amarlo ogn'hor s'accende,<br>
      Sperando co'l suo sol farsi immortale?
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/scema_il_tempo_fugace_ogni_martire/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
