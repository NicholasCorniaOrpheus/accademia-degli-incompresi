# Chi è costei, che come nuova Aurora (5rpRyMExvrGB)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/5rpRyMExvrGB.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/5rpRyMExvrGB.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/5rpRyMExvrGB.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/chi_è_costei,_che_come_nuova_aurora){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Chi è costei, che come nuova Aurora
    - id: 5rpRyMExvrGB
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/5rpRyMExvrGB.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [1093](https://lyra.unil.ch/poems/1093)
...
???+ abstract "text"
    - CHI è costei, che come nuova Aurora,<br>
      Ma più chiara del Sol, che la Tauro torni,<br>
      In sul finir de' miei ultimi giorni<br>
      Lo smarrito cor mio desta, & colora?<br>
      <br>
      Move da le sue rose una dolcie ora<br>
      Di vaghi accenti, & di santi atti adorni,<br>
      Che, quasi seco Amor spiri, & soggiorni,<br>
      Me neve, & gel di bei desiri infiora;<br>
      <br>
      Onde non pur la scorza fredda, & bianca,<br>
      Ma prenda qualità a la parte interna,<br>
      Di voi cortese Dea, perpetuo tempio:<br>
      <br>
      Gardir per lei questa altra inferma, & stanca<br>
      Gratia a me rara, a voi fia gloria eterna,<br>
      Rinovellando di Titon l'essempio.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/chi_è_costei,_che_come_nuova_aurora/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
