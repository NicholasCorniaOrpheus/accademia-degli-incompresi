# Repertorio della Poesia Italiana in Musica, 1500-1700 (UFWerrYngAnv)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/UFWerrYngAnv.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/UFWerrYngAnv.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/UFWerrYngAnv.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Repertorio della Poesia Italiana in Musica, 1500-1700
    - id: UFWerrYngAnv
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/UFWerrYngAnv.json";
    </script>
...
???+ abstract "official website"
    - [repim.itatti.harvard.edu](https://repim.itatti.harvard.edu/)
