# Libraria della Luna (iqikNWstKK7g)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/iqikNWstKK7g.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/iqikNWstKK7g.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/iqikNWstKK7g.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Libraria della Luna
    - aliases: Libreria della Luna
    - id: iqikNWstKK7g
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/iqikNWstKK7g.json";
    </script>
...
???+ abstract "instance of"
    - [publishing house](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/o3Jj53NDsjgB)
