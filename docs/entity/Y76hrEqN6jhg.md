# Quando de la mia dolce empia guerriera (Y76hrEqN6jhg)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/Y76hrEqN6jhg.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/Y76hrEqN6jhg.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/Y76hrEqN6jhg.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/quando_de_la_mia_dolce_empia_guerriera){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Quando de la mia dolce empia guerriera
    - id: Y76hrEqN6jhg
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/Y76hrEqN6jhg.json";
    </script>
...
???+ abstract "part of"
    - [Rime di diversi eccellenti autori bresciani](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/D7Lfbq5eiaTi)
        * pages: 67
        * section: Il Conte Fortunato Martinengo.
...
???+ abstract "text"
    - Quando de la mia dolce empia guerriera<br>
      Chiamo l'altero nome, che nel core<br>
      Sì saldamente mi descrisse Amore<br>
      Ond'altri nol può trar, che morte fera,<br>
      <br>
      I primi accenti suoi, con gioia intera<br>
      Far mi ponno beato a tutte l'hore<br>
      L'alto in amor suo trionfal valore,<br>
      Fa che l'alma riacquisti, e fama vera;<br>
      <br>
      Ma in fine il mio Signor m'accenna, e dice<br>
      Convien tenere il bel nome celato,<br>
      Che più oltre parlarne a te non lice;<br>
      <br>
      Dunque viver mi fa sempre beato<br>
      Questa nova de i cor vera BEATRICE <br>
      E scorge l'alma a fin chiaro e lodato.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/quando_de_la_mia_dolce_empia_guerriera/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
