# Quanti son poi, che divenuti amanti (Torresani) (NyRnJP545oAm)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/NyRnJP545oAm.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/NyRnJP545oAm.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/NyRnJP545oAm.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/vault/assets/music_compositions/torresani-quanti_son_poi,_che_divenuti_amanti){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/NyRnJP545oAm.json";
    </script>
...
???+ abstract "instance of"
    - [madrigal](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/YxEnVGWtDSGW)

???+ abstract "contributor"
    - [[Bartolomeo Torresani]]
        * role: [composer](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/aYLRpFh35Pid)

???+ abstract "part of"
    - [[Primo libro de Madrigali a quatro voci di l'Hoste da Reggio]]
