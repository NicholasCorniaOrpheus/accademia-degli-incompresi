# Se quando per Adone, over per Marte (Fiesco) (RedSi25YNdBz)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/RedSi25YNdBz.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/RedSi25YNdBz.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/RedSi25YNdBz.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/vault/assets/music_compositions/fiesco-se_quando_per_adone,_over_per_marte){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/RedSi25YNdBz.json";
    </script>
...
???+ abstract "part of"
    - [[Di Giulio Fiesco il primo libro di madrigali a quattro voci]]

???+ abstract "based on"
    - [[Se quando per Adone, over per Marte]]
