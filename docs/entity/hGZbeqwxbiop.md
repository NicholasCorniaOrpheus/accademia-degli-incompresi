# partbook (hGZbeqwxbiop)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/hGZbeqwxbiop.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/hGZbeqwxbiop.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/hGZbeqwxbiop.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: partbook
    - description: Music book composed of separate parts.
    - aliases: polyphonic book
    - id: hGZbeqwxbiop
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/hGZbeqwxbiop.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q4366612](http://www.wikidata.org/entity/Q4366612)
