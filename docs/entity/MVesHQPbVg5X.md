# metaphor (MVesHQPbVg5X)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/MVesHQPbVg5X.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/MVesHQPbVg5X.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/MVesHQPbVg5X.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: metaphor
    - description: Figure of speech in which one thing is asserted to be another when it is in fact not so, based on properties of the latter that apply to the former, pointing to similarity.
    - id: MVesHQPbVg5X
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/MVesHQPbVg5X.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q18534](http://www.wikidata.org/entity/Q18534)

???+ abstract "instance of"
    - [rhetorical figure](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/6YzSraKZVaNv)
