# Giuoco delle Virtù (KxcsDiAvoi7U)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/KxcsDiAvoi7U.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/KxcsDiAvoi7U.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/KxcsDiAvoi7U.csv){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/assets/icons/concept.png" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Concept
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/KxcsDiAvoi7U.json";
    </script>
...
## Notes
```
Il Giuoco delle Virtù, che voi sapete, crebbe tanto che diventò reame; e questo carnovale vi si son fattte cose divine, perché ogni settimana sedeva un re, quale avea una cena, e ognuno l'avea a presentar d'una stravaganza e d'una composizione, che a gara tanto l'uno dell'altro e gli re e i vassalli hanno fatto cose che danno che a dire a tutta Roma [...]
```
Letter by [Benedetto Varchi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/TdyZG6fXKCLc)
