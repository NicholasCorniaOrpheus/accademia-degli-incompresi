# Accademia di San Luca di Roma (VLH3Xgfkhtes)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/VLH3Xgfkhtes.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/VLH3Xgfkhtes.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/VLH3Xgfkhtes.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Accademia di San Luca di Roma
    - aliases: Accademia del Disegno di Roma
    - id: VLH3Xgfkhtes
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/VLH3Xgfkhtes.json";
    </script>
