# (Toffetti et al. 2026) (V4dxiKAaioCZ)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/V4dxiKAaioCZ.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/V4dxiKAaioCZ.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/V4dxiKAaioCZ.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Toffetti et al. 2026)
    - aliases: toffettiMusicareDBDatabase2026
    - id: V4dxiKAaioCZ
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/V4dxiKAaioCZ.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [zenodo.21234768](https://doi.org/10.5281/zenodo.21234768)

???+ abstract "citation"
    - Toffetti, Marina, Gabriele Taschetti, Chiara Comparin, and Enrico Scavo. 2026. ‘Musicare DB – A Database of Incomplete Printed Music. Project “MUSICARE. Musiche Incomplete: Censimento, Analisi, Restituzione / Taking CARE of Incomplete MUSIC”’. Zenodo. doi:10.5281/ZENODO.21234768.
