# Rime diverse d'alcune nobilissime, et virtuosissime donne (KsqUZ8dKXxDW)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/KsqUZ8dKXxDW.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/KsqUZ8dKXxDW.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/KsqUZ8dKXxDW.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: Rime diverse d'alcune nobilissime, et virtuosissime donne
    - id: KsqUZ8dKXxDW
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graphgraph/KsqUZ8dKXxDW.json";
    </script>
...
???+ abstract "title"
    - Rime diuerse d'alcune nobilissime, et virtuosissime donne, raccolte per m. Lodouico Domenichi, e intitolate al signor Giannotto Castiglione gentil'huomo milanese

???+ abstract "has version"
    - 
        * place of publication: [Lucca](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/XSSWJuarq3FG)
        * publisher: [Vincenzo Busdraghi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/AE5GjpNrgXhG)
        * publication date: 1559
        * permalink: [CNCE017557](https://edit16.iccu.sbn.it/titolo/CNCE017557)
        * external source: [10B1F7B3](https://viewer.onb.ac.at/10B1F7B3/)
        * IIIF manifest: [10B1F7B3](https://api.onb.ac.at/iiif/presentation/v3/manifest/10B1F7B3)
...
???+ abstract "contributor"
    ...
    - [Virginia Martini Salvi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/cnEPDxq7rFvj)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)
    - [Lodovico Domenichi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/S6k4cZpBdTPw)
        * role: [editor](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dbNtcx3kn4i7)

???+ abstract "identifier"
    - [CNCE017557](https://edit16.iccu.sbn.it/titolo/CNCE017557)

???+ abstract "described by source"
    - [(Robin 2007)](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/cV7inRaDCFsd)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://api.onb.ac.at/iiif/presentation/v3/manifest/10B1F7B3"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://api.onb.ac.at/iiif/presentation/v3/manifest/10B1F7B3"]
  };
</script>
