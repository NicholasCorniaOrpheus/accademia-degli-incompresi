# Mentre lontana sol contemplo quella (aTJxVyegiife)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/aTJxVyegiife.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/aTJxVyegiife.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/aTJxVyegiife.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/accademia-degli-incompresi/assets/poems/mentre_lontata_sol_contemplo_quella){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Mentre lontana sol contemplo quella
    - id: aTJxVyegiife
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/aTJxVyegiife.json";
    </script>
...
???+ abstract "contributor"
    - [Giovanni Maria Bonardo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/U54h5JspdXgD)
        * role: [dedicatee](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/5GmrgRoxsCpY)
    - [Issicratea Monte](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/PqX4kUDKqx44)
        * role: [author](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/awZyTsJZqrUq)

???+ abstract "part of"
    - [Madrigali del cavalier Gio. Maria Bonardo fratteggiano](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/iDJjy4U3Wogz)
        * section: Sonetto della Sig. Issicratea Monte al C.B.F.
        * pages: 34
        * volume: 2nd edition
...
???+ abstract "text"
    - Mentre lontana sol contemplo quella<br>
      Vostra rara virtù, degna di rima<br>
      Spinge ad alzarmi all'alta cagion prima<br>
      Un non so, che divin, ch'io scorgo in ella.<br>
      <br>
      Quinci s'apre la via, diritta, e bella,<br>
      Onde il mio nome poggi in ogni clima<br>
      Ne'l bagni oblio di lete, o roda lima<br>
      D'invida o furi mai proterva stella.<br>
      <br>
      Quinci l'alma produce, un pensier saggio,<br>
      Che mi cerca inalzar, con bianche piume,<br>
      E portar dalli Esperi, a lidi Eoi,<br>
      <br>
      Se dunque luce in me benigno raggio,<br>
      O si scopre virtù del divin lume<br>
      Tutto BONARDO sol nasce da voi.
...
window.kbGraphConfig.assets = {
  ...
  local_path: "assets/poems/mentre_lontata_sol_contemplo_quella/",
  images: ["001.jpg"],
  iiif: []
};
</script>
