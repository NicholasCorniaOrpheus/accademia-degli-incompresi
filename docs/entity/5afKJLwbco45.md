# Madrigali a cinque voci di Alessandro Savioli. Libro secondo (5afKJLwbco45)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/5afKJLwbco45.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/5afKJLwbco45.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/5afKJLwbco45.csv){ .md-button }
...
!!! note "metadata"
    - class: NotatedMusic
    - label: Madrigali a cinque voci di Alessandro Savioli. Libro secondo
    - id: 5afKJLwbco45
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/5afKJLwbco45.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [990057577](https://rism.online/sources/990057577)
    - [http%3A%2F%2Frepim.unibo.it%2Fresource%2FBOOK%2FNV19280010](https://repim.itatti.harvard.edu/resource/?uri=http%3A%2F%2Frepim.unibo.it%2Fresource%2FBOOK%2FNV19280010)
    - [CNCE045364](https://edit16.iccu.sbn.it/titolo/CNCE045364)
...
???+ abstract "title"
    - Madrigali a cinque voci di Alessandro Savioli maestro di capella in Santo Alessandro di Bergamo. Libro secondo

???+ abstract "has version"
    - 
        * permalink: [CNCE045364](https://edit16.iccu.sbn.it/titolo/CNCE045364)
        * holding institution: [Public Library Leipzig](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/7Szxsh2Xinkm)
        * external source: [8546](https://sachsen.digital/werkansicht?tx_dlf[id]=8546)
        * IIIF manifest: [manifest.json](https://iiif.slub-dresden.de/iiif/2/456284141/manifest.json)
...
???+ abstract "contributor"
    - [Alessandro Savioli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/PcoxH8gLXvkz)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://iiif.slub-dresden.de/iiif/2/456284141/manifest.json"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://iiif.slub-dresden.de/iiif/2/456284141/manifest.json"]
  };
</script>
