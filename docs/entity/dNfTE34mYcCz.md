# Felicissime voi, Donne beate (dNfTE34mYcCz)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/dNfTE34mYcCz.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/dNfTE34mYcCz.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/dNfTE34mYcCz.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/felicissime_voi,_donne_beate){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Felicissime voi, Donne beate
    - id: dNfTE34mYcCz
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/dNfTE34mYcCz.json";
    </script>
...
???+ abstract "contributor"
    - [Ippolita Benigni Manfredi](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/YSZok6nzRFh6)
...
???+ abstract "part of"
    - [Componimenti poetici delle piu' illustri rimatrici d'ogni secolo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ENUbQJ8t6z8B)
        * section: Ippolita Benegni. Manfredi.
        * pages: 61
        * volume: 2
...
???+ abstract "depicts"
    ...
    - [resurrection](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/7XvSZ7b7KwWq)

???+ abstract "language"
    - [Italian](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/85kGqMwffVs7)

???+ abstract "text"
    - Felicissime voi, Donne beate,<br>
      Che cercando il Signore,<br>
      Morto per vostro amore<br>
      Vivo il trovaste, e benché nol vedeste,<br>
      All'Angelo il credeste:<br>
      E in vece di unger lui,<br>
      Ristorate, ed allegre foste vui;<br>
      E con ragion s'ei vi promise ancora<br>
      La vista sua poco più là d'allora:<br>
      Or dite pur, com'ei vi disse agl'altri;<br>
      E fatti Uomini sien da Donne scaltri.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/felicissime_voi,_donne_beate/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
