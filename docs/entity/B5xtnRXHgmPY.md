# Accademia degli Infecondi di Roma (B5xtnRXHgmPY)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/B5xtnRXHgmPY.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/B5xtnRXHgmPY.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/B5xtnRXHgmPY.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Accademia degli Infecondi di Roma
    - id: B5xtnRXHgmPY
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/B5xtnRXHgmPY.json";
    </script>
...
???+ abstract "member"
    - [Elena Cornaro Piscopia](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/aR27UgntvNYH)
        ...
        * pseudonym: L'Inalterabile

???+ abstract "interested in"
    - [Romanesco](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/bqMdW5xvKJx7)
        * reference: [(Everson 2017)](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/mvo9Fng6Hu9m)
