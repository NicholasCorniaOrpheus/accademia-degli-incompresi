# juxtaposition (3eQerXqUEkt2)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/3eQerXqUEkt2.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/3eQerXqUEkt2.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/3eQerXqUEkt2.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: juxtaposition
    - aliases: Act of placing two (contrasting) elements side by side
    - id: 3eQerXqUEkt2
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/3eQerXqUEkt2.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q3393049](http://www.wikidata.org/entity/Q3393049)
