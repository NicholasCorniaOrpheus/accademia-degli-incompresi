# (Corso 2017) (MmYBcxDcaCgT)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/MmYBcxDcaCgT.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/MmYBcxDcaCgT.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/MmYBcxDcaCgT.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Corso 2017)
    - aliases: corsoVirtuDellanticoCompagnia2017
    - id: MmYBcxDcaCgT
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/MmYBcxDcaCgT.json";
    </script>
...
???+ abstract "citation"
    - Corso, Michela. 2017. ‘In virtù dell’antico. La compagnia dei Virtuosi del Panthenon nel Cinquecento’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Paolo Procaccioli, 111–23. Roma: De Luca editori d’arte.
