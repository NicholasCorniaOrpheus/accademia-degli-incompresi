# Fatto è pittor'il Sol di raro ingegno (FjbGUJYPHrL6)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/FjbGUJYPHrL6.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/FjbGUJYPHrL6.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/FjbGUJYPHrL6.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/fatto_è_pittor'il_sol_di_raro_ingegno){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/FjbGUJYPHrL6.json";
    </script>
...
???+ abstract "part of"
    - [Fiori di sacra poesia dell'Irresoluto Accademico Intronato](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dM6ssUyYVPtG)
        * section: Nel veder la sua ombra in terra polverosa
        * pages: 2
...
???+ abstract "depicts"
    ...
    - [shadow](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/fNnw4P8dLQ5w)
    - [ingenuity](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/755zYzGryekA)

???+ abstract "text"
    - Fatto è pittor'il Sol di raro ingegno,<br>
      Che con pennel di luce un'ombra finge,<br>
      E per ritrarmi al vivo, in terra pinge.<br>
      Pittor'in ver di peregrin disegno,<br>
      Ne la polve m'adombra;<br>
      Perch'altro non son'io, che polve, & ombra.
