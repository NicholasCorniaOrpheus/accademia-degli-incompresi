# (Geremicca 2017) (3XnpJ3vZQnbp)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/3XnpJ3vZQnbp.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/3XnpJ3vZQnbp.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/3XnpJ3vZQnbp.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Geremicca 2017)
    - aliases: geremiccaDamoneperCrisero2017
    - id: 3XnpJ3vZQnbp
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/3XnpJ3vZQnbp.json";
    </script>
...
???+ abstract "citation"
    - Geremicca, Antonio. 2017. ‘“Damone” per “Crisero” e gli altri. Benedetto Varchi e gli artisti (prima e dopo l’Accademia Fiorentina)’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 11–26. Roma: De Luca editori d’arte.
