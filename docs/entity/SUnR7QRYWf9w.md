# Se satia ancor non sie crudel Fortuna (SUnR7QRYWf9w)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/SUnR7QRYWf9w.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/SUnR7QRYWf9w.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/SUnR7QRYWf9w.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/se_satia_ancor_non_sei_crudel_fortuna){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Se satia ancor non sie crudel Fortuna
    - id: SUnR7QRYWf9w
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/SUnR7QRYWf9w.json";
    </script>
...
???+ abstract "depicts"
    ...
    - [Fortuna](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/n4nZUvENWhDP)

???+ abstract "text"
    - Se SATIA ancor non sie crudel Fortuna<br>
      Di contrastar' ogn'hora a' miei desiri,<br>
      E colmarmi di doglia, e di martiri,<br>
      Di novo contra me tue forze aduna.<br>
      <br>
      Che non sia mai però mai d'Amor digiuna<br>
      La mente mia, e pria pianti, e sospiri<br>
      Saranno in Ciel, né più faran suoi giri<br>
      Le stelle, e fia del Sol la luce bruna;<br>
      <br>
      Ch'Amor disciolga la forte catena,<br>
      Con cui preso, e legato tiemmi il core,<br>
      O ch'in me novo ardor' haggia mai loco.<br>
      <br>
      Perché'l mio destin vuol, ch'ogni mia pena<br>
      Termini, amando infin' a l'ultim'hore,<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/se_satia_ancor_non_sei_crudel_fortuna/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
