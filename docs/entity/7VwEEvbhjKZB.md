# (Moroncini 2017) (7VwEEvbhjKZB)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/7VwEEvbhjKZB.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/7VwEEvbhjKZB.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/7VwEEvbhjKZB.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Moroncini 2017)
    - aliases: moronciniGiuocoVirtuIntreccio2017
    - id: 7VwEEvbhjKZB
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/7VwEEvbhjKZB.json";
    </script>
...
???+ abstract "citation"
    - Moroncini, Ambra. 2017. ‘Il «Giuoco de la Virtù »: un intreccio accademico tra “Stravaganze” letterarie e suggestioni evangeliche’. In Intrecci virtuosi: letterati, artisti e accademie tra Cinque e Seicento, edited by Carla Chiummo, Antonio Geremicca, and Patrizia Tosini, 101–10. Roma: De Luca editori d’arte.
