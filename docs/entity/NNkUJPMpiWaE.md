# Cingati homai de' suoi più verdi allori (NNkUJPMpiWaE)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/NNkUJPMpiWaE.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/NNkUJPMpiWaE.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/NNkUJPMpiWaE.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/cingati_homai_de'_suoi_verdi_allori){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Cingati homai de' suoi più verdi allori
    - aliases: Cingati omai de' suoi più verdi allori
    - id: NNkUJPMpiWaE
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/NNkUJPMpiWaE.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [14990](https://lyra.unil.ch/poems/14990)
...
???+ abstract "part of"
    - [Rime di Gio. Battista Marino, amorose, marittime, boscherecce, heroiche, lugubri, morali, sacre, & varie](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/bEkUf4bv5Dgj)
        * section: Alla Signora Margherita Sarocchi. Risposta.
        * pages: 225
...
???+ abstract "depicts"
    - [Apollo](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/R4q38qZbHK3Y)
    - [laurel](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/kxH89uEZ8Uxe)
    - [swan](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/7refGZLnjZsh)
...
???+ abstract "text"
    - CINGATI homai de' suoi più verdi allori<br>
      Apoloo il crin con sempiterno Aprile:<br>
      Con auree penne homai da Battro a Thile<br>
      Spieghi la Fama i tuoi veraci honori:<br>
      <br>
      MARINO, hor tu l'età del ferro indori<br>
      Co'raggi del tu'ingegno alto, e sottile;<br>
      Col chiaro canto, appo cui sembra humile<br>
      Qual più sublime a' secoli migliori.<br>
      <br>
      Gloria a te, pena a me si deve, e duolo,<br>
      Cui lieti non aprì mai tanto, o quanto<br>
      Per le mie colpe, i suoi bei lumi il polo.<br>
      <br>
      Pur credi, che non poco ancor nel pianto.<br>
      Ch'esca del mio bel nido, hor mi consolo,<br>
      Cigno, che le sue piume alzi cotanto.
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/cingati_homai_de'_suoi_verdi_allori/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
