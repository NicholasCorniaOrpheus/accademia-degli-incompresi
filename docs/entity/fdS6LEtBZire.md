# (Sangalli 2020) (fdS6LEtBZire)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/fdS6LEtBZire.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/fdS6LEtBZire.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/fdS6LEtBZire.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Sangalli 2020)
    - aliases: sangalliChurchUniversityAcademies2020
    - id: fdS6LEtBZire
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/fdS6LEtBZire.json";
    </script>
...
???+ abstract "citation"
    - Sangalli, Maurizio. 2020. ‘Between Church, University and Academies: Paolo Beni in Padua, 1599-1623’. In The Italian Academies 1525-1700: Networks of Culture, Innovation and Dissent, edited by Jane E. Everson, Denis V. Reidy, and Lisa Sampson, 118–29. Italian Perspectives 31. London New York: Routledge, Taylor & Francis Group.
