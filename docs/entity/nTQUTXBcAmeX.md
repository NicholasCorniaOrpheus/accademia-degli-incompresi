# condottiero (nTQUTXBcAmeX)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/nTQUTXBcAmeX.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/nTQUTXBcAmeX.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/nTQUTXBcAmeX.csv){ .md-button }
...
!!! note "metadata"
    - class: Concept
    - label: condottiero
    - aliases: condottiere; venture captain
    - id: nTQUTXBcAmeX
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graph/nTQUTXBcAmeX.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [Q273108](http://www.wikidata.org/entity/Q273108)
