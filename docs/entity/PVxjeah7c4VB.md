# Da chi debbo sperar mai tregua o pace (PVxjeah7c4VB)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/PVxjeah7c4VB.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/PVxjeah7c4VB.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/PVxjeah7c4VB.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Da chi debbo sperar mai tregua o pace
    - id: PVxjeah7c4VB
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/PVxjeah7c4VB.json";
    </script>
...
???+ abstract "text"
    - Da chi debbo sperar mai tregua o pace<br>
      Se quel ch'agli altri giova<br>
      A me sol nuoce, mi consuma e sface?<br>
      <br>
      Il tempo si suol dir che l'aspre pene<br>
      E li cocenti ardori<br>
      Se non in tutto allegerisse alquanto,<br>
      <br>
      Ma ahi, lassa! in me tutt'il contrario aviene,<br>
      Ch'al rinovar dei fiori<br>
      Rinova i vecchi amori,<br>
      E in compagnia di lor la doglia e 'l pianto.<br>
      <br>
      Qual sia dunque il mio stato acerbo e quanto<br>
      Sia il mio constante amore,<br>
      Quanta sia la mia fede,<br>
