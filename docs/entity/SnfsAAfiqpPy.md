# (Ray 2015) (SnfsAAfiqpPy)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/SnfsAAfiqpPy.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/SnfsAAfiqpPy.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/SnfsAAfiqpPy.csv){ .md-button }
...
!!! note "metadata"
    ...
    - label: (Ray 2015)
    - aliases: rayDaughtersAlchemyWomen2015
    - id: SnfsAAfiqpPy
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/SnfsAAfiqpPy.json";
    </script>
...
## Statements
???+ abstract "citation"
    - Ray, Meredith K. 2015. Daughters of Alchemy: Women and Scientific Culture in Early Modern Italy. Harvard University Press.
