# Se sempre ritrovasti in me l'amore (gMJcWcBFeFhd)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/gMJcWcBFeFhd.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/gMJcWcBFeFhd.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/gMJcWcBFeFhd.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Se sempre ritrovasti in me l'amore
    - id: gMJcWcBFeFhd
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/gMJcWcBFeFhd.json";
    </script>
...
???+ abstract "based on"
    - [Ruggier, qual sempre fui, tal esser voglio](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/MrwKLwDFwkkz)
        * note: Extension and readaptation of the stanza in the Spanish glosa tradition.

???+ abstract "subject"
    - [perseverance](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/jNVGi7b6DTsP)
    - [epistolary poem](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/2Z7GLcNcoqn4)
...
???+ abstract "depicts"
    - [Bradamante](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/7fvcZ2G9nhHD)

???+ abstract "language"
    - [Italian](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/85kGqMwffVs7)

???+ abstract "text"
    - Se sempre ritrovasti in me l'amore,<br>
      In me la fede immobil o sincera,<br>
      Non pensare ritrovarla unqua minore<br>
      O vadi autunno, o passi pimavera.<br>
      Sol vo' che riguardiamo al nostro honore<br>
      Ché, machiati ambidoi d'altra maniera,<br>
      Giamai di pianto asciugarei le gote<br>
      Fin'alla morte, o più, se più si pote.
