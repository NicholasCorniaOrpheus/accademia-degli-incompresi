# I fiori delle rime de' poeti illustri, nuouamente raccolti et ordinati da Girolamo Ruscelli (LME5KJSzDF8c)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/LME5KJSzDF8c.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/LME5KJSzDF8c.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/LME5KJSzDF8c.csv){ .md-button }
...
!!! note "metadata"
    - class: Book
    - label: I fiori delle rime de' poeti illustri, nuouamente raccolti et ordinati da Girolamo Ruscelli
    - id: LME5KJSzDF8c
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/graphgraph/LME5KJSzDF8c.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [CNCE079995](https://edit16.iccu.sbn.it/titolo/CNCE079995)

???+ abstract "instance of"
    - [poetry collection](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/XzeQyQXbyjmR)

???+ abstract "title"
    - I fiori delle rime de' poeti illustri, nuouamente raccolti et ordinati da Girolamo Ruscelli. Con alcune annotationi del medesimo, sopra i luoghi, che le ricercano per l'intendimento delle sentenze, o per le regole et precetti della lingua, et dell'ornamento

???+ abstract "has version"
    - 
        * publisher: [Melchiorre Sessa](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/SrrS6eL33FJc)
        ...
        * external source: [LO1E000757](https://www.polodigitalenapoli.it/it/viewer/mirador/viewer?domain=sbn&id=LO1E000757)
        * IIIF manifest: [manifest](https://dam.polodigitalenapoli.it/istituto-italiano-per-gli-studi-storici/containers/yRdroBl/manifest)
        * permalink: [CNCE079995](https://edit16.iccu.sbn.it/titolo/CNCE079995)
...
??? abstract "Digitised images"
    ...
    <div id="openseadragon-container-0" style="height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #333; margin-bottom: 12px;">
      <div id="osd-viewer-0" class="osd-viewer" data-manifest='"https://dam.polodigitalenapoli.it/istituto-italiano-per-gli-studi-storici/containers/yRdroBl/manifest"' style="width:100%; height:100%;"></div>
    </div>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "/",
    images: [],
    iiif: ["https://dam.polodigitalenapoli.it/istituto-italiano-per-gli-studi-storici/containers/yRdroBl/manifest"]
  };
</script>
