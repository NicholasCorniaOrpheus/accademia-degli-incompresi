# Altri pur dica. Che ne' falsi chiostri (cH4pHQVs2iGZ)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/cH4pHQVs2iGZ.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/cH4pHQVs2iGZ.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/cH4pHQVs2iGZ.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/altri_pur_dica._che_ne'_falsi_chiostri){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Altri pur dica. Che ne' falsi chiostri
    - id: cH4pHQVs2iGZ
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/cH4pHQVs2iGZ.json";
    </script>
...
???+ abstract "part of"
    - [Rime di Ottavio Tronsarelli](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/YwBMpr45NG8a)
        * section: Loda la Sig. Margherita N. di belleza, e di virtù.
        * pages: 354
...
???+ abstract "depicts"
    ...
    - [monster](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/ixSMpi2apRwe)

???+ abstract "text"
    - Altri pur dica. Che ne' falsi chiostri,<br>
      Ove il terrore ha rigido ricetto,<br>
      Traggan la vita portentosi mostri<br>
      Di fiere luci, e di mortale aspetto,<br>
      Che, se di rimirar gli aurori, e gli ostri<br>
      Del sen, del volto tuo non m'è disdetto,<br>
      Altro ridir non puon quest'occhi miei,<br>
      Se non, che di bellezza un mostro sei.
