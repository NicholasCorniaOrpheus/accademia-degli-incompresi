# Spenta è d'Amor la face, il dardo è rotto (a8Sr8CwEgp9s)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/a8Sr8CwEgp9s.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/a8Sr8CwEgp9s.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/a8Sr8CwEgp9s.csv){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Spenta è d'Amor la face, il dardo è rotto
    - id: a8Sr8CwEgp9s
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/a8Sr8CwEgp9s.json";
    </script>
...
???+ abstract "text"
    - Spenta è d’Amor la face, il dardo è rotto,<br>
      E l’arco e la faretra e ogni sua possa,<br>
      Poi che ha Morte crudel la pianta scossa,<br>
      A la cui ombra cheta io dormia sotto.<br>
      <br>
      Deh perché non poss’io la breve fossa<br>
      Seco entrar, dove l’ha il destin condotto,<br>
      Colui che appena cinque giorni e otto<br>
      Amor legò pria de la gran percossa?<br>
      <br>
      Vorrei col foco mio quel freddo ghiaccio<br>
      Intepidire, e rimpastar col pianto<br>
      La polve, e ravvivarla a nuova vita:<br>
      <br>
      E vorrei poscia, baldanzosa e ardita,<br>
