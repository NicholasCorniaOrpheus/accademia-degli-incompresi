# Mesta, e pentita de' miei gravi errori (8YHDRqxYZAfT)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/8YHDRqxYZAfT.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/8YHDRqxYZAfT.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/8YHDRqxYZAfT.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/mesta,_e_pentita_de'_miei_gravi_errori){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Mesta, e pentita de' miei gravi errori
    - id: 8YHDRqxYZAfT
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/8YHDRqxYZAfT.json";
    </script>
...
???+ abstract "subject"
    - [religion](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/e4z5crPAxqJa)
...
???+ abstract "depicts"
    ...
    - [sin](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/KGrBx8dKLuSe)
...
???+ abstract "text"
    - Mesta, e pentita de' miei gravi errori<br>
      E del mio vaneggiar tanto, e sì lieve,<br>
      E d'haver speso questo tempo breve,<br>
      De la vita fugace in vani amori,<br>
      <br>
      A te, Signor, ch'intenerisci i cori,<br>
      E rendi calda la gelata neve;<br>
      E fai soave ogn'aspro peso, e greve,<br>
      A chiunque accendi di tuoi santi ardori,<br>
      <br>
      Ricorro, e prego, che mi porghi mano<br>
      A trarmi fuor del pelago, onde uscire,<br>
      S'io tentassi da me, sarebbe vano.<br>
      <br>
      Tu volesti per noi, Signor, morire,<br>
      Tu ricomprasti tutto il seme umano,<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/mesta,_e_pentita_de'_miei_gravi_errori/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
