# Quel nodo, in cui la mia beata sorte (gDSq2nQpyxVy)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/gDSq2nQpyxVy.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/gDSq2nQpyxVy.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/gDSq2nQpyxVy.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/accademia-degli-incompresi/tree/main/data/vault/assets/poems/quel_nodo,_in_cui_la_mia_beata_sorte){ .md-button }
...
!!! note "metadata"
    - class: PoeticWork
    - label: Quel nodo, in cui la mia beata sorte
    - id: gDSq2nQpyxVy
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/gDSq2nQpyxVy.json";
    </script>
...
???+ abstract "subject"
    - [afterlife](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/an73BTiK6nrr)
...
???+ abstract "text"
    - Quel nodo, in cui la mia beata sorte,<br>
      Per ordine del Ciel legommi e strinse<br>
      Con mio grave dolor sciolse, e discinse<br>
      Quella crudel, ch'il mondo chiama Morte.<br>
      <br>
      E fu l'affano sì gravoso, e forte,<br>
      Che i miei piacer tutti in un punto estinse:<br>
      E se non, che ragione al fin pur vinse,<br>
      Fatte avrei mie giornate assai più corte.<br>
      <br>
      Ma il timor sol di non andar in parte<br>
      Troppo lontana a quella, ove il bel viso<br>
      Risplende sopra ogni lucente stella,<br>
      <br>
      Mitigato ha il furor: (che ingeno, od arte<br>
      Far nol potea) sperando in Paradiso<br>
...
<script>
  ...
  window.kbGraphConfig.assets = {
    ...
    local_path: "assets/poems/quel_nodo,_in_cui_la_mia_beata_sorte/",
    images: ["001.jpg"],
    iiif: []
  };
</script>
