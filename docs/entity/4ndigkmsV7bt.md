# De floridi virtuosi d'Italia, il secondo libro de madrigali a cinque voci (4ndigkmsV7bt)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/json/4ndigkmsV7bt.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/rdf/4ndigkmsV7bt.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/csv/4ndigkmsV7bt.csv){ .md-button }
...
!!! note "metadata"
    - class: NotatedMusic
    - label: De floridi virtuosi d'Italia, il secondo libro de madrigali a cinque voci
    - id: 4ndigkmsV7bt
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/accademia-degli-incompresi/main/data/accademia-degli-incompresi/graph/4ndigkmsV7bt.json";
    </script>
...
## Statements
???+ abstract "identifier"
    - [993120764](https://rism.online/sources/993120764)
    - [http%3A%2F%2Frepim.unibo.it%2Fresource%2FBOOK%2FNV52150010](https://repim.itatti.harvard.edu/resource/?uri=http%3A%2F%2Frepim.unibo.it%2Fresource%2FBOOK%2FNV52150010)
    - [CNCE043012](https://edit16.iccu.sbn.it/titolo/CNCE043012)
...
???+ abstract "title"
    - De floridi virtuosi d'Italia, il secondo libro de madrigali a cinque voci, nouamente composti, et dati in luce
...
???+ abstract "has version"
    - 
        ...
        * permalink: [CNCE043012](https://edit16.iccu.sbn.it/titolo/CNCE043012)
        * external source: [98rmpqg9rx](https://edl.cultura.gov.it/item/98rmpqg9rx)
        * IIIF manifest: [manifest](https://edl-jarvis.cultura.gov.it/meta/iiif/9f358872-1482-46d5-bfc8-89a7ea955f7d/manifest)

???+ abstract "contributor"
    - [composer](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/h24pafkqqHsZ)
        * role: [Bartolomeo Spontone](https://nicholascorniaorpheus.github.io/accademia-degli-incompresi/entity/dWoW3ShusMpX)
